...
#elif	(defined DDR_533M)
#define DDR_FREQ        533000000
#else
#define DDR_FREQ        400000000
#endif

#define DCDC_ARM	1050	//1050mv + efuse(150mv) = 1200mv
#define DCDC_CORE	900		//900mv + 150mv = 1050mv
...
/*sin1 input clock*/
#define	CONFIG_SIN1_26M_TUNED	0
#define	CONFIG_SIN1_32M_TUNED	1
#define	CONFIG_SIN1_26M_UNTUNED	2 /*to solve deepchannel problem*/
#define	CONFIG_SIN1_CLOCK	CONFIG_SIN1_26M_UNTUNED

//should be delete. only open for compile by zs(0316)
...
#define DDR_SIZE_FIXED_ON
#define DDR_FIXED_SIZE 0x20000000
...
//#define DDR_TIMING_TYPICAL
//#define DDR_TIMING_SLOW
//#define DDR_TIMING_FAST
