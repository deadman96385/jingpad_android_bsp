...
#define MBIST_LV_BLOCK 6
#define MBIST_JUDGE_BIT (BIT(0)|BIT(27))
...
#define BOOT_FLAG_ADDRESS 0x50013FF4
...
#else
#define CLK_CA7_CORE    768000000
#endif
#define CLK_CA7_AXI     CLK_750M
#define CLK_CA7_DGB     CLK_750M
...
#else
#define DDR_FREQ        192000000
#endif
#ifdef CONFIG_NAND_SPL
#define DCDC_ARM	1200
#define DCDC_CORE	1050
#else
#define DCDC_ARM	1050
#define DCDC_CORE	1050
#endif
