...
#define CONFIG_SYS_NAND_U_BOOT_SIZE	0x96000
...
//#define CUSTOM_BOARD_SUPPORT
/* DDR */
#define DRAM_LPDDR3_750M
//#define DDR_AUTO_DETECT
#ifdef DRAM_LPDDR3_750M
  #ifdef CONFIG_NAND_SPL
  #define DDR_FREQ 750000000      //power on freq
  #else
  #define DDR_FREQ 500000000      //download freq
  #endif
#else
  #ifdef CONFIG_NAND_SPL
  #define DDR_FREQ 920000000      //power on freq
  #else
  #define DDR_FREQ 460000000      //download freq
  #endif
#endif
#define DDR_MODE 0      //DDR debug mode
#define DRAM_LPDDR3
#define DDR_DFTYPE_LP4 DRAM_LPDDR4_2CS_16G_X8
