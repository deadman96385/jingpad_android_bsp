...
#define CHIPRAM_ENV_ADDR 0xfffb8000
...
#define CONFIG_SYS_UFS_U_BOOT_SECTOR_NUM ((CONFIG_SYS_NAND_U_BOOT_SIZE+UFS_SECTOR_SIZE-1)/UFS_SECTOR_SIZE)
#endif
...
#define CONFIG_SYS_NAND_U_BOOT_DST	0x7F000000
