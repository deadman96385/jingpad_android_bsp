...
#define CLK_DDR_FREQ        933000000//power on mode
#else
#define CLK_DDR_FREQ        368000000//download mode
#endif
...
#ifdef CONFIG_NAND_SPL
#define DDR_FREQ 933000000      //power on freq
#else
#define DDR_FREQ 368000000      //download freq
#endif
#endif
#define DRAM_LPDDR3
