...
#define CLK_CA55_CORE4  CLK_1570M

#define CLK_SCU         CLK_1350M
...
#define CFG_DRAM_TYPE	DRAM_LPDDR4
#define CFG_IO_MODE     IO_LP4
//#define CFG_PINMUX_CASE LP3_PINMUX_CASE0
#define CFG_PINMUX_CASE LP4_PINMUX_CASE2
