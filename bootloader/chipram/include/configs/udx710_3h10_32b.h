...
#define BOOT_FLAG_ADDRESS 0x28005028
...
#define CONFIG_SYS_NAND_U_SML_OFFS	0x180000
#define CONFIG_SYS_NAND_U_TOS_OFFS	0x240000
...
#define TOS_LOAD_MAX_SIZE       (256*1024)
...
#define CLK_CORE0	CLK_1352M
#define CLK_CORE1	CLK_1352M
#define CLK_SCU         CLK_1014M
#define CLK_ACE         (CLK_SCU/2)

#ifdef CONFIG_NAND_SPL
#define CLK_DDR_FREQ        1536000000
#else
...
#define DCDC_CPU	800
#define DCDC_GPU	800
#define DCDC_SRAM	800
#define DCDC_GEN1	1300
...
#define CLK_AXI_LEVEL               6
#define CLK_AXI_LEVEL_ID            5
#define CLK_PERI_APB_LEVEL          4
#define CLK_PERI_APB_LEVEL_ID       3
#define CLK_APCPU_AXI_LEVEL         4
#define CLK_APCPU_AXI_LEVEL_ID      3
