 ...
 */
//#define CONFIG_FPGA
//#define CONFIG_WHALE2_FPGA
#define CONFIG_WHALE2
//#define CONFIG_SCX35L64
#define CONFIG_SP9860_3GFHD
//
//
...
#define SML_LOAD_MAX_SIZE       (0xC800) //NOT be excess 50K,or ovrelap spl whale2.
#define TOS_LOAD_MAX_SIZE       (1024*1024)
#define CONFIG_SML_LDADDR_START (0x800)
...
#define CLK_CA53_CORE0	CLK_1250M
#else
#define CLK_CA53_CORE0	768000000
#endif

#define CLK_CA53_CORE1	CLK_1500M
...
#ifdef CONFIG_NAND_SPL
#define CLK_DDR_FREQ        1200000000
#else
