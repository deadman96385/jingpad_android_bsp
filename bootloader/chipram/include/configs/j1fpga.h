 ...
 */
#define CONFIG_FPGA
#define CONFIG_SHARKLJ1_FPGA

#define CONFIG_SOC_SHARKLJ1
#define BOOT_FLAG_ADDRESS 0x50007FF4
...
#define CONFIG_DUALPHASE
//#define CONFIG_AUTODETECT_SS
...
#define SML_LOAD_MAX_SIZE       (0x10000) //NOT be excess 50K,or ovrelap spl whale2.
#define TOS_LOAD_MAX_SIZE       (2*1024*1024)
#define CONFIG_SML_LDADDR_START (0x50000400)
#define CONFIG_TOS_LDADDR_START (0x8f600000)
...
#define CLK_CA53_CORE0	CLK_1000M
#else
#define CLK_CA53_CORE0	CLK_1000M
#endif

#define CLK_CA53_CORE1	CLK_950M
#define CLK_DGB0_FREQ	CLK_CA53_CORE0/4
#define CLK_DGB1_FREQ   CLK_CA53_CORE1/4
#define CLK_ACE0_FREQ   CLK_CA53_CORE0
#define CLK_ACE1_FREQ   CLK_CA53_CORE1/2
#define CLK_ATB0_FREQ   CLK_CA53_CORE0/4
#define CLK_ATB1_FREQ   CLK_CA53_CORE1/4

#ifdef CONFIG_NAND_SPL
#define CLK_DDR_FREQ        667000000
#else
#define CLK_DDR_FREQ        400000000
#endif
...
#else
#define DCDC_ARM0	750
#define DCDC_ARM1	750
#endif
...
#define CLK_CCI_LEVEL 6
#define CLK_CCI_LEVEL_ID 3
#define CLK_APB_LEVEL 4
#define CLK_APB_LEVEL_ID 3
#define CLK_PUB_AHB_LEVEL 4
#define CLK_PUB_AHB_LEVEL_ID 3
