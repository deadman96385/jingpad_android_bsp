...
#define ANA_REGS_GLB_PHYS	(ANA_REGS_GLB_BASE)

/* registers definitions for controller ANA_REGS_GLB */
#define ANA_REG_GLB_ARM_MODULE_EN       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0000)
#define ANA_REG_GLB_ARM_CLK_EN          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0004)
#define ANA_REG_GLB_RTC_CLK_EN          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0008)
#define ANA_REG_GLB_ARM_RST             SCI_ADDR(ANA_REGS_GLB_PHYS, 0x000C)
#define ANA_REG_GLB_LDO_DCDC_PD_RTCSET  SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0010)
#define ANA_REG_GLB_LDO_DCDC_PD_RTCCLR  SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0014)
#define ANA_REG_GLB_RTC_CTRL            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0018)
#define ANA_REG_GLB_LDO_PD_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x001C)
#define ANA_REG_GLB_LDO_V_CTRL0         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0020)
#define ANA_REG_GLB_LDO_V_CTRL1         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0024)
#define ANA_REG_GLB_LDO_V_CTRL2         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0028)
#define ANA_REG_GLB_LDO_CAL_CTRL0       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x002C)
#define ANA_REG_GLB_LDO_CAL_CTRL1       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0030)
#define ANA_REG_GLB_LDO_CAL_CTRL2       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0034)
#define ANA_REG_GLB_LDO_CAL_CTRL3       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0038)
#define ANA_REG_GLB_LDO_CAL_CTRL4       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x003C)
#define ANA_REG_GLB_LDO_CAL_CTRL5       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0040)
#define ANA_REG_GLB_LDO_CAL_CTRL6       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0044)
#define ANA_REG_GLB_AUXAD_CTL           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0048)
#define ANA_REG_GLB_DCDC_CTRL0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x004C)
#define ANA_REG_GLB_DCDC_CTRL1          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0050)
#define ANA_REG_GLB_DCDC_CTRL2          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0054)
#define ANA_REG_GLB_DCDC_CTRL3          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0058)
#define ANA_REG_GLB_DCDC_CTRL4          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x005C)
#define ANA_REG_GLB_DCDC_CTRL5          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0060)
#define ANA_REG_GLB_DCDC_CTRL6          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0064)
#define ANA_REG_GLB_DDR2_CTRL           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0068)
#define ANA_REG_GLB_SLP_WAIT_DCDCARM    SCI_ADDR(ANA_REGS_GLB_PHYS, 0x006C)
#define ANA_REG_GLB_LDO1828_XTL_CTL     SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0070)
#define ANA_REG_GLB_LDO_SLP_CTRL0       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0074)
#define ANA_REG_GLB_LDO_SLP_CTRL1       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0078)
#define ANA_REG_GLB_LDO_SLP_CTRL2       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x007C)
#define ANA_REG_GLB_LDO_SLP_CTRL3       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0080)
#define ANA_REG_GLB_AUD_SLP_CTRL4       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0084)
#define ANA_REG_GLB_DCDC_SLP_CTRL       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0088)
#define ANA_REG_GLB_XTL_WAIT_CTRL       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x008C)
#define ANA_REG_GLB_FLASH_CTRL          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0090)
#define ANA_REG_GLB_WHTLED_CTRL0        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0094)
#define ANA_REG_GLB_WHTLED_CTRL1        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0098)
#define ANA_REG_GLB_WHTLED_CTRL2        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x009C)
#define ANA_REG_GLB_ANA_DRV_CTRL        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00A0)
#define ANA_REG_GLB_VIBR_CTRL0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00A4)
#define ANA_REG_GLB_VIBR_CTRL1          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00A8)
#define ANA_REG_GLB_VIBR_CTRL2          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00AC)
#define ANA_REG_GLB_VIBR_WR_PROT_VALUE  SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00B0)
#define ANA_REG_GLB_AUDIO_CTRL          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00B4)
#define ANA_REG_GLB_CHGR_CTRL0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00B8)
#define ANA_REG_GLB_CHGR_CTRL1          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00BC)
#define ANA_REG_GLB_CHGR_CTRL2          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00C0)
#define ANA_REG_GLB_CHGR_STATUS         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00C4)
#define ANA_REG_GLB_ANA_MIXED_CTRL      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00C8)
#define ANA_REG_GLB_PWR_XTL_EN0         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00CC)
#define ANA_REG_GLB_PWR_XTL_EN1         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00D0)
#define ANA_REG_GLB_PWR_XTL_EN2         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00D4)
#define ANA_REG_GLB_PWR_XTL_EN3         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00D8)
#define ANA_REG_GLB_PWR_XTL_EN4         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00DC)
#define ANA_REG_GLB_PWR_XTL_EN5         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00E0)
#define ANA_REG_GLB_ANA_STATUS          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00E4)
#define ANA_REG_GLB_POR_RST_MONITOR     SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00E8)
#define ANA_REG_GLB_WDG_RST_MONITOR     SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00EC)
#define ANA_REG_GLB_POR_PIN_RST_MONITOR SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00F0)
#define ANA_REG_GLB_POR_SRC_FLAG        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00F4)
#define ANA_REG_GLB_POR_7S_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00F8)
#define ANA_REG_GLB_INT_DEBUG           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00FC)
#define ANA_REG_GLB_GPI_DEBUG           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0100)
#define ANA_REG_GLB_HWRST_RTC           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0104)
#define ANA_REG_GLB_CHIP_ID_LOW         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0108)
#define ANA_REG_GLB_CHIP_ID_HIGH        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x010C)
#define ANA_REG_GLB_ARM_MF_REG          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0110)
#define ANA_REG_GLB_AFUSE_CTRL          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0114)
#define ANA_REG_GLB_AFUSE_OUT0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0118)
#define ANA_REG_GLB_AFUSE_OUT1          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x011C)
#define ANA_REG_GLB_AFUSE_OUT2          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0120)
#define ANA_REG_GLB_AFUSE_OUT3          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0124)
#define ANA_REG_GLB_CA_CTRL4            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0128)
...
#define ANA_REG_GLB_MP_PWR_CTRL1        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0134)
#define ANA_REG_GLB_MP_PWR_CTRL2        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0138)
#define ANA_REG_GLB_MP_PWR_CTRL3        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x013C)
#define ANA_REG_GLB_MP_LDO_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0140)
#define ANA_REG_GLB_MP_CHG_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0144)
#define ANA_REG_GLB_MP_MISC_CTRL        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0148)
#define ANA_REG_GLB_MP_DCDC_DEDT_CTRL   SCI_ADDR(ANA_REGS_GLB_PHYS, 0x014C)
#define ANA_REG_GLB_CA_CTRL0            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0150)
#define ANA_REG_GLB_CA_CTRL1            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0154)
#define ANA_REG_GLB_CA_CTRL2            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0158)
#define ANA_REG_GLB_CA_CTRL3            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x015C)
...
#define ANA_REG_GLB_DCDC_MEM_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0168)
#define ANA_REG_GLB_DCDC_GEN_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x016C)
#define ANA_REG_GLB_DCDC_WRF_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0170)
#define ANA_REG_GLB_DCDC_WPA_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0174)
#define ANA_REG_GLB_DCDC_WPA_DCM_ADI    SCI_ADDR(ANA_REGS_GLB_PHYS, 0x017C)

#define ANA_REG_GLB_LDO_CAL_SEL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0044)
