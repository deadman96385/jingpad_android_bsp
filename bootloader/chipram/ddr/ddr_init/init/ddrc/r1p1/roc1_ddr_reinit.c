...
#define BIT_PMU_APB_PUB_SYS_SMART_LSLP_ENA                         (1 << 10)
...
//	#endif
	{0, RE_CLK_256M,TWPLL, {0x4, 0x0,DESKEW_BYAPSS, 0x1, 0x2, 0x1, 0x1}},
	{1, RE_CLK_384M,TWPLL, {0x5, 0x0,DESKEW_BYAPSS, 0x1, 0x2, 0x1, 0x1}},
	{2, RE_CLK_667M,DPLL0,  {0x0, 0x0,DESKEW_BYAPSS, 0x1, 0x2, 0x1, 0x1}},
	{3, RE_CLK_768M,TWPLL,  {0x6, 0x0,DESKEW_OFF, 0x2, 0x2, 0x1, 0x0}},
	{4, RE_CLK_1024M,TWPLL, {0x4, 0x0,DESKEW_ON, 0x0, 0x0, 0x0, 0x0}},
	{5, RE_CLK_1333M,DPLL0, {0x0, 0x1,DESKEW_ON, 0x0, 0x0, 0x0, 0x0}},
	{6, RE_CLK_1536M,TWPLL, {0x5, 0x0,DESKEW_ON, 0x0, 0x0, 0x0, 0x0}},
	{7, RE_CLK_1866M,DPLL1, {0x1, 0x0,DESKEW_ON, 0x0, 0x0, 0x0, 0x0}}
#endif
};
...
//	state=(REG32(DDR_SLP_CTRL_CFG0))&0xf;
...
//	reg_bit_set(&ctl_reg1_data[(75-64)],4,3,sys_info->freq_num);//drf_dfs_reg_sel
  //      pub_clk_update();
	...
	while(((REG32(PWR_STATUS2_DBG)>>24)&0xff) != 0x0);//pd_pub_sys_state
...
void pub_auto_poweroff_set()
{
	...
	reg_bit_set(SLEEP_CTL2,20,1,0x1);
...
{
	clk_cfg=lp4_clk_info;
//	sys_info =((REG32(DMC_CTL_(0))>>29)&0x1);
	sys_info->freq_num=(REG32(DMC_CTL_(75))>>8)&0x7;
