...
DMC_PUB_CLK_CFG dmc_pub_clk_cfg[8] =
{
	...
	//{3, PUB_CLK_768M,TWPLL,  {0x6, 0x0,DESKEW_BYAPSS, 0x2, 0x2, 0x1, 0x0}},
...
//	if (ddr_chip_cur.chip_type == DRAM_LPDDR4)
	...
	/*port prefetch setting*/
	val = pdmc->dmc_cfg4;
	val = u32_bits_set(val, 0, 16, 0x2);
	val = u32_bits_set(val, 16, 3, 0x1);
	val = u32_bits_set(val, 19, 1, 0x1);
	pdmc->dmc_cfg4 = val;
