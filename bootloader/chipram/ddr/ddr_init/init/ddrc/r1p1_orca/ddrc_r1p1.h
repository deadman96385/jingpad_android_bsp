...
#define DMC_REG_ADDR_BASE_PHY (0x61000000)
#define PUB_AHB_ADDR_BASE_BIST 0x61070000
#define DMC_GUCPHY0_BASE		(0x61001000)
#define PMU_APB_BASE_ADDR		(0x64010000)
#define PUB_APB_BASE			(0x61050000)
#define PUB_AHB_BASE			(0x61030000)
#define PUB_NIC400_MERGE_MTX_ADDR	(0x61090000)
#define PUB_NIC400_CROSS_MTX_ADDR	(0x61091000)
...
#define CHIP_RESET_CONTROL_BASE_ADDR		(0x63360000)
...
#define AON_RAM_FOR_DDR					(0x6000)
#define AON_RAM_FOR_DDR_SIZE				(0x1000)
