...
#include <security/sprd_ce_r2p0lite.h>
...
void sprd_ce_pub_reset(void){
	*(volatile u32 *)(s_ahb_vaddr + REG_AP_AHB_CE_SEC_SOFT_RST_OFFSET) |= (uint32_t)(BIT_AP_AHB_CE_PUB_SOFT_RST);
}
#endif

void sprd_ce_init() {
#if defined(CONFIG_SOC_SHARKL5) || defined(CONFIG_SOC_ROC1) || defined(CONFIG_SOC_SHARKL5PRO)
	s_ahb_vaddr = (void*)CTL_BASE_AP_APB;
	sprd_ce_pub_reset();
#else
