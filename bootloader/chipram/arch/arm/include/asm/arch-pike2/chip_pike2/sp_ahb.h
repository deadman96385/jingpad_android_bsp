...
#define CTL_BASE_SP_AHB 0x50820000


#define REG_SP_AHB_CM4_EB                 ( CTL_BASE_SP_AHB + 0x0000 )
#define REG_SP_AHB_CM4_SOFT_RST           ( CTL_BASE_SP_AHB + 0x0004 )
#define REG_SP_AHB_SLP_CTL                ( CTL_BASE_SP_AHB + 0x0008 )
#define REG_SP_AHB_CM4_CORE_CFG           ( CTL_BASE_SP_AHB + 0x000C )
#define REG_SP_AHB_CM4_CORE_AUXFAULT_CFG  ( CTL_BASE_SP_AHB + 0x0010 )
#define REG_SP_AHB_CM4_MAIN_STATOUT       ( CTL_BASE_SP_AHB + 0x0014 )
#define REG_SP_AHB_CM4_HWDATAD_STAT       ( CTL_BASE_SP_AHB + 0x0018 )
#define REG_SP_AHB_CM4_INT_STAT           ( CTL_BASE_SP_AHB + 0x001C )
#define REG_SP_AHB_CM4_CLK_EMC_CTRL       ( CTL_BASE_SP_AHB + 0x0020 )
#define REG_SP_AHB_CM4_MTX_LP_CTRL        ( CTL_BASE_SP_AHB + 0x0024 )
#define REG_SP_AHB_DUMMY                  ( CTL_BASE_SP_AHB + 0x0040 )
