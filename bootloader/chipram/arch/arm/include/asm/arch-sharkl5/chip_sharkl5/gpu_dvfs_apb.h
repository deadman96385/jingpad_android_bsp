...
#define BIT_GPU_DVFS_APB_GPU_DVFS_UP_WINDOW(x)              (((x) & 0x3FF) << 10)
#define BIT_GPU_DVFS_APB_GPU_DVFS_DOWN_WINDOW(x)            (((x) & 0x3FF))
...
#define BIT_GPU_DVFS_APB_GPU_TOP_DVFS_BUSY                  BIT(13)
#define BIT_GPU_DVFS_APB_GPU_DVFS_WINDOW_CNT(x)             (((x) & 0x3FF) << 3)
