...
#define REG_AP_DVFS_APB_AP_DFS_SW_TRIG_CFG             ( CTL_BASE_AP_DVFS_APB + 0x0014 )
...
#define REG_AP_DVFS_APB_VDSP_INDEX0_MAP                ( CTL_BASE_AP_DVFS_APB + 0x0054 )
#define REG_AP_DVFS_APB_VDSP_INDEX1_MAP                ( CTL_BASE_AP_DVFS_APB + 0x0058 )
#define REG_AP_DVFS_APB_VDSP_INDEX2_MAP                ( CTL_BASE_AP_DVFS_APB + 0x005C )
#define REG_AP_DVFS_APB_VDSP_INDEX3_MAP                ( CTL_BASE_AP_DVFS_APB + 0x0060 )
#define REG_AP_DVFS_APB_VDSP_INDEX4_MAP                ( CTL_BASE_AP_DVFS_APB + 0x0064 )
#define REG_AP_DVFS_APB_VDSP_INDEX5_MAP                ( CTL_BASE_AP_DVFS_APB + 0x0068 )
#define REG_AP_DVFS_APB_VDSP_INDEX6_MAP                ( CTL_BASE_AP_DVFS_APB + 0x006C )
#define REG_AP_DVFS_APB_VDSP_INDEX7_MAP                ( CTL_BASE_AP_DVFS_APB + 0x0070 )
...
#define REG_AP_DVFS_APB_VDSP_DVFS_INDEX_CFG            ( CTL_BASE_AP_DVFS_APB + 0x0114 )
#define REG_AP_DVFS_APB_VDSP_DVFS_INDEX_IDLE_CFG       ( CTL_BASE_AP_DVFS_APB + 0x0118 )
...
#define REG_AP_DVFS_APB_AP_DFS_IDLE_DISABLE_CFG        ( CTL_BASE_AP_DVFS_APB + 0x0140 )
#define REG_AP_DVFS_APB_AP_DVFS_RESERVED_REG_CFG0      ( CTL_BASE_AP_DVFS_APB + 0x0150 )
#define REG_AP_DVFS_APB_AP_DVFS_RESERVED_REG_CFG1      ( CTL_BASE_AP_DVFS_APB + 0x0154 )
#define REG_AP_DVFS_APB_AP_DVFS_RESERVED_REG_CFG2      ( CTL_BASE_AP_DVFS_APB + 0x0158 )
#define REG_AP_DVFS_APB_AP_DVFS_RESERVED_REG_CFG3      ( CTL_BASE_AP_DVFS_APB + 0x015C )
...
#define BIT_AP_DVFS_APB_AP_DVFS_UP_WINDOW(x)          (((x) & 0xFFFF) << 16)
#define BIT_AP_DVFS_APB_AP_DVFS_DOWN_WINDOW(x)        (((x) & 0xFFFF))
...
/* REG_AP_DVFS_APB_AP_DFS_SW_TRIG_CFG */

#define BIT_AP_DVFS_APB_DISPC_DFS_SW_TRIG             BIT(2)
#define BIT_AP_DVFS_APB_VSP_DFS_SW_TRIG               BIT(1)
#define BIT_AP_DVFS_APB_VDSP_DFS_SW_TRIG              BIT(0)
...
#define BIT_AP_DVFS_APB_VDSP_VOLTAGE(x)               (((x) & 0x7) << 9)
...
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_DVFS(x)       (((x) & 0x3) << 10)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_DVFS(x)     (((x) & 0x3) << 8)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_DVFS(x)          (((x) & 0x7) << 5)
...
#define BIT_AP_DVFS_APB_AP_DVFS_WINDOW_CNT(x)         (((x) & 0xFFFF) << 3)
#define BIT_AP_DVFS_APB_AP_DVFS_STATE(x)              (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX0_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX0(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX0(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX0(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX0(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX1_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX1(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX1(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX1(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX1(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX2_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX2(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX2(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX2(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX2(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX3_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX3(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX3(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX3(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX3(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX4_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX4(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX4(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX4(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX4(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX5_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX5(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX5(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX5(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX5(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX6_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX6(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX6(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX6(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX6(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX7_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX7(x)            (((x) & 0x7) << 7)
#define BIT_AP_DVFS_APB_CGM_VDSP_M0_DIV_INDEX7(x)     (((x) & 0x3) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_EDAP_DIV_INDEX7(x)   (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX7(x)        (((x) & 0x7))
...
/* REG_AP_DVFS_APB_VDSP_DVFS_INDEX_CFG */

#define BIT_AP_DVFS_APB_VDSP_DVFS_INDEX(x)            (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_DVFS_INDEX_IDLE_CFG */

#define BIT_AP_DVFS_APB_VDSP_DVFS_INDEX_IDLE(x)       (((x) & 0x7))
...
#define BIT_AP_DVFS_APB_VDSP_DVFS_FREQ_UPD_STATE(x)   (((x) & 0xF))

/* REG_AP_DVFS_APB_AP_GFREE_WAIT_DELAY_CFG */

#define BIT_AP_DVFS_APB_VDSP_GFREE_WAIT_DELAY(x)      (((x) & 0x3FF) << 20)
...
/* REG_AP_DVFS_APB_AP_DFS_IDLE_DISABLE_CFG */
