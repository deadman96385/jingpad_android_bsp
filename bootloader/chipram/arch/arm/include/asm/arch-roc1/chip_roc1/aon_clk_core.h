...
#define REG_AON_CLK_CORE_CGM_AON_I2C1_CFG         ( CTL_BASE_AON_CLK_CORE + 0x0080 )
#define REG_AON_CLK_CORE_CGM_AON_IIS_CFG          ( CTL_BASE_AON_CLK_CORE + 0x0084 )
#define REG_AON_CLK_CORE_CGM_SCC_CFG              ( CTL_BASE_AON_CLK_CORE + 0x0088 )
#define REG_AON_CLK_CORE_CGM_APCPU_DAP_CFG        ( CTL_BASE_AON_CLK_CORE + 0x008C )
#define REG_AON_CLK_CORE_CGM_APCPU_DAP_MTCK_CFG   ( CTL_BASE_AON_CLK_CORE + 0x0090 )
#define REG_AON_CLK_CORE_CGM_APCPU_TS_CFG         ( CTL_BASE_AON_CLK_CORE + 0x0094 )
#define REG_AON_CLK_CORE_CGM_DEBUG_TS_CFG         ( CTL_BASE_AON_CLK_CORE + 0x0098 )
#define REG_AON_CLK_CORE_CGM_DSI_TEST_S_CFG       ( CTL_BASE_AON_CLK_CORE + 0x009C )
#define REG_AON_CLK_CORE_CGM_RFTI_SBI_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00A0 )
#define REG_AON_CLK_CORE_CGM_RFTI1_XO_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00A4 )
#define REG_AON_CLK_CORE_CGM_RFTI_LTH_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00A8 )
#define REG_AON_CLK_CORE_CGM_RFTI2_XO_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00AC )
#define REG_AON_CLK_CORE_CGM_RCO100M_REF_CFG      ( CTL_BASE_AON_CLK_CORE + 0x00B0 )
#define REG_AON_CLK_CORE_CGM_RCO100M_FDK_CFG      ( CTL_BASE_AON_CLK_CORE + 0x00B4 )
#define REG_AON_CLK_CORE_CGM_DJTAG_TCK_CFG        ( CTL_BASE_AON_CLK_CORE + 0x00B8 )
#define REG_AON_CLK_CORE_CGM_DJTAG_TCK_HW_CFG     ( CTL_BASE_AON_CLK_CORE + 0x00BC )
#define REG_AON_CLK_CORE_CGM_SP_AHB_CFG           ( CTL_BASE_AON_CLK_CORE + 0x00C0 )
#define REG_AON_CLK_CORE_CGM_TMR_CFG              ( CTL_BASE_AON_CLK_CORE + 0x00C4 )
#define REG_AON_CLK_CORE_CGM_DET_32K_CFG          ( CTL_BASE_AON_CLK_CORE + 0x00C8 )
#define REG_AON_CLK_CORE_CGM_PMU_CFG              ( CTL_BASE_AON_CLK_CORE + 0x00CC )
#define REG_AON_CLK_CORE_CGM_DEBOUNCE_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00D0 )
#define REG_AON_CLK_CORE_CGM_APCPU_PMU_CFG        ( CTL_BASE_AON_CLK_CORE + 0x00D4 )
#define REG_AON_CLK_CORE_CGM_FUNC_DMA_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00D8 )
#define REG_AON_CLK_CORE_CGM_TOP_DVFS_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00DC )
#define REG_AON_CLK_CORE_CGM_26M_PMU_CFG          ( CTL_BASE_AON_CLK_CORE + 0x00E0 )
#define REG_AON_CLK_CORE_CGM_OTG_UTMI_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00E4 )
#define REG_AON_CLK_CORE_CGM_OTG_REF_CFG          ( CTL_BASE_AON_CLK_CORE + 0x00E8 )
#define REG_AON_CLK_CORE_CGM_CSSYS_CFG            ( CTL_BASE_AON_CLK_CORE + 0x00EC )
#define REG_AON_CLK_CORE_CGM_CSSYS_PUB_CFG        ( CTL_BASE_AON_CLK_CORE + 0x00F0 )
#define REG_AON_CLK_CORE_CGM_CSSYS_APB_CFG        ( CTL_BASE_AON_CLK_CORE + 0x00F4 )
#define REG_AON_CLK_CORE_CGM_WCDMA_CFG            ( CTL_BASE_AON_CLK_CORE + 0x00F8 )
#define REG_AON_CLK_CORE_CGM_AP_AXI_CFG           ( CTL_BASE_AON_CLK_CORE + 0x00FC )
#define REG_AON_CLK_CORE_CGM_AP_MM_CFG            ( CTL_BASE_AON_CLK_CORE + 0x0100 )
#define REG_AON_CLK_CORE_CGM_AP_GPU_CFG           ( CTL_BASE_AON_CLK_CORE + 0x0104 )
#define REG_AON_CLK_CORE_CGM_AP_AI_CFG            ( CTL_BASE_AON_CLK_CORE + 0x0108 )
#define REG_AON_CLK_CORE_CGM_SDIO2_2X_CFG         ( CTL_BASE_AON_CLK_CORE + 0x010C )
#define REG_AON_CLK_CORE_CGM_SDIO2_1X_CFG         ( CTL_BASE_AON_CLK_CORE + 0x0110 )
#define REG_AON_CLK_CORE_CGM_ANALOG_IO_APB_CFG    ( CTL_BASE_AON_CLK_CORE + 0x0114 )
#define REG_AON_CLK_CORE_CGM_DMC_REF_CFG          ( CTL_BASE_AON_CLK_CORE + 0x0118 )
#define REG_AON_CLK_CORE_CGM_USB20_SCAN_ONLY_CFG  ( CTL_BASE_AON_CLK_CORE + 0x011C )
#define REG_AON_CLK_CORE_CGM_EMC_CFG              ( CTL_BASE_AON_CLK_CORE + 0x0120 )
#define REG_AON_CLK_CORE_CGM_USB_CFG              ( CTL_BASE_AON_CLK_CORE + 0x0124 )
#define REG_AON_CLK_CORE_CGM_EFUSE_ESE_CFG        ( CTL_BASE_AON_CLK_CORE + 0x0128 )
#define REG_AON_CLK_CORE_CGM_AAPC_TEST_CFG        ( CTL_BASE_AON_CLK_CORE + 0x012C )
#define REG_AON_CLK_CORE_CGM_USB_SUSPEND_CFG      ( CTL_BASE_AON_CLK_CORE + 0x0130 )
#define REG_AON_CLK_CORE_CGM_UFS_AON_CFG          ( CTL_BASE_AON_CLK_CORE + 0x0134 )
#define REG_AON_CLK_CORE_CGM_ESE_SYS_CFG          ( CTL_BASE_AON_CLK_CORE + 0x0138 )
#define REG_AON_CLK_CORE_PCIE_CGM_SCAN_768M_CFG   ( CTL_BASE_AON_CLK_CORE + 0x013C )
#define REG_AON_CLK_CORE_PCIE_CGM_SCAN_384M_CFG   ( CTL_BASE_AON_CLK_CORE + 0x0140 )
#define REG_AON_CLK_CORE_PCIE_CGM_SCAN_192M_CFG   ( CTL_BASE_AON_CLK_CORE + 0x0144 )
#define REG_AON_CLK_CORE_PCIE_CGM_SCAN_96M_CFG    ( CTL_BASE_AON_CLK_CORE + 0x0148 )
#define REG_AON_CLK_CORE_PCIE_CGM_SCAN_48M_CFG    ( CTL_BASE_AON_CLK_CORE + 0x014C )
...
/* REG_AON_CLK_CORE_CGM_AON_I2C1_CFG */

#define BIT_AON_CLK_CORE_CGM_AON_I2C1_CFG_CGM_AON_I2C1_SEL(x)               (((x) & 0x7))
...
/* REG_AON_CLK_CORE_CGM_AP_GPU_CFG */

#define BIT_AON_CLK_CORE_CGM_AP_GPU_CFG_CGM_AP_GPU_SEL(x)                   (((x) & 0x3))

/* REG_AON_CLK_CORE_CGM_AP_AI_CFG */

#define BIT_AON_CLK_CORE_CGM_AP_AI_CFG_CGM_AP_AI_SEL(x)                     (((x) & 0x3))
...
/* REG_AON_CLK_CORE_CGM_EFUSE_ESE_CFG */

#define BIT_AON_CLK_CORE_CGM_EFUSE_ESE_CFG_CGM_EFUSE_ESE_SEL                BIT(0)
...
/* REG_AON_CLK_CORE_CGM_USB_SUSPEND_CFG */

#define BIT_AON_CLK_CORE_CGM_USB_SUSPEND_CFG_CGM_USB_SUSPEND_SEL            BIT(0)

/* REG_AON_CLK_CORE_CGM_UFS_AON_CFG */

#define BIT_AON_CLK_CORE_CGM_UFS_AON_CFG_CGM_UFS_AON_SEL                    BIT(0)

/* REG_AON_CLK_CORE_CGM_ESE_SYS_CFG */

#define BIT_AON_CLK_CORE_CGM_ESE_SYS_CFG_CGM_ESE_SYS_DIV(x)                 (((x) & 0x7) << 8)
#define BIT_AON_CLK_CORE_CGM_ESE_SYS_CFG_CGM_ESE_SYS_SEL                    BIT(0)

/* REG_AON_CLK_CORE_PCIE_CGM_SCAN_768M_CFG */

#define BIT_AON_CLK_CORE_PCIE_CGM_SCAN_768M_CFG_PCIE_CGM_SCAN_768M_SEL      BIT(0)

/* REG_AON_CLK_CORE_PCIE_CGM_SCAN_384M_CFG */

#define BIT_AON_CLK_CORE_PCIE_CGM_SCAN_384M_CFG_PCIE_CGM_SCAN_384M_SEL      BIT(0)

/* REG_AON_CLK_CORE_PCIE_CGM_SCAN_192M_CFG */

#define BIT_AON_CLK_CORE_PCIE_CGM_SCAN_192M_CFG_PCIE_CGM_SCAN_192M_SEL      BIT(0)

/* REG_AON_CLK_CORE_PCIE_CGM_SCAN_96M_CFG */

#define BIT_AON_CLK_CORE_PCIE_CGM_SCAN_96M_CFG_PCIE_CGM_SCAN_96M_SEL        BIT(0)

/* REG_AON_CLK_CORE_PCIE_CGM_SCAN_48M_CFG */

#define BIT_AON_CLK_CORE_PCIE_CGM_SCAN_48M_CFG_PCIE_CGM_SCAN_48M_SEL        BIT(0)
