...
typedef struct{
    ...
    volatile unsigned int  clk_vol_unit_count;//22
    volatile unsigned int clk_list_unit_count;//11
    ...
    CLK_LIST_UNIT ap_gpu_freq;
    CLK_LIST_UNIT ap_ai_freq;
    CLK_LIST_UNIT vdsp_freq;
    CLK_LIST_UNIT ap_apb_freq;
    CLK_LIST_UNIT aon_apb_freq;
    CLK_LIST_UNIT ipa_core_freq;
