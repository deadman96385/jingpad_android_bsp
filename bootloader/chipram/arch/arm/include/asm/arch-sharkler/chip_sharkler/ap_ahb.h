...
#define REG_AP_AHB_CA53_RST_SET                    ( CTL_BASE_AP_AHB + 0x0008 )
...
#define REG_AP_AHB_JMP_ADDR_CA53_C0                ( CTL_BASE_AP_AHB + 0x0018 )
#define REG_AP_AHB_JMP_ADDR_CA53_C1                ( CTL_BASE_AP_AHB + 0x001C )
#define REG_AP_AHB_JMP_ADDR_CA53_C2                ( CTL_BASE_AP_AHB + 0x0020 )
#define REG_AP_AHB_JMP_ADDR_CA53_C3                ( CTL_BASE_AP_AHB + 0x0024 )
#define REG_AP_AHB_CA53_C0_PU_LOCK                 ( CTL_BASE_AP_AHB + 0x0028 )
#define REG_AP_AHB_CA53_C1_PU_LOCK                 ( CTL_BASE_AP_AHB + 0x002C )
#define REG_AP_AHB_CA53_C2_PU_LOCK                 ( CTL_BASE_AP_AHB + 0x0030 )
#define REG_AP_AHB_CA53_C3_PU_LOCK                 ( CTL_BASE_AP_AHB + 0x0034 )
#define REG_AP_AHB_CA53_CKG_DIV_CFG                ( CTL_BASE_AP_AHB + 0x0038 )
#define REG_AP_AHB_MCU_PAUSE                       ( CTL_BASE_AP_AHB + 0x003C )
#define REG_AP_AHB_MISC_CKG_EN                     ( CTL_BASE_AP_AHB + 0x0040 )
#define REG_AP_AHB_CA53_C0_AUTO_FORCE_SHUTDOWN_EN  ( CTL_BASE_AP_AHB + 0x0044 )
#define REG_AP_AHB_CA53_C1_AUTO_FORCE_SHUTDOWN_EN  ( CTL_BASE_AP_AHB + 0x0048 )
#define REG_AP_AHB_CA53_C2_AUTO_FORCE_SHUTDOWN_EN  ( CTL_BASE_AP_AHB + 0x004C )
#define REG_AP_AHB_DISP_ASYNC_BRG                  ( CTL_BASE_AP_AHB + 0x0050 )
#define REG_AP_AHB_CA53_CKG_SEL_CFG                ( CTL_BASE_AP_AHB + 0x0054 )
...
#define REG_AP_AHB_MERGE_M2_LPC                    ( CTL_BASE_AP_AHB + 0x00A8 )
#define REG_AP_AHB_MERGE_S0_LPC                    ( CTL_BASE_AP_AHB + 0x00AC )
#define REG_AP_AHB_AP_QOS0                         ( CTL_BASE_AP_AHB + 0x00B0 )
#define REG_AP_AHB_CPU_ASYNC_BRIDGE                ( CTL_BASE_AP_AHB + 0x00B4 )
#define REG_AP_AHB_AP_QOS1                         ( CTL_BASE_AP_AHB + 0x00B8 )
#define REG_AP_AHB_AP_QOS2                         ( CTL_BASE_AP_AHB + 0x00BC )
#define REG_AP_AHB_CA53_L2                         ( CTL_BASE_AP_AHB + 0x00C0 )
#define REG_AP_AHB_CA53_MTX_LP                     ( CTL_BASE_AP_AHB + 0x00C4 )
#define REG_AP_AHB_S6_LPC                          ( CTL_BASE_AP_AHB + 0x00C8 )
#define REG_AP_AHB_CA53_STANDBY_STATUS             ( CTL_BASE_AP_AHB + 0x3008 )
...
#define REG_AP_AHB_CE_SEC_EB                       ( CTL_BASE_AP_AHB + 0x3038 )
#define REG_AP_AHB_CE_SEC_SOFT_RST                 ( CTL_BASE_AP_AHB + 0x303C )
#define REG_AP_AHB_DMA_SOFT_RST                    ( CTL_BASE_AP_AHB + 0x3040 )
#define REG_AP_AHB_DMA_SEC_EB                      ( CTL_BASE_AP_AHB + 0x3044 )
