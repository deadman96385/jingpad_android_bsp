...
#else
#define SPRD_ADISLAVE_PHYS              (0x63a08000)
#endif
...
#define EMMC_BASE_ADDR                                  SPRD_EMMC_TOP_PHYS
#define SDIO0_BASE_ADDR                                 SPRD_SDIO_MST_TOP_PHYS
#define SPRD_AONCKG_BASE                                SPRD_CLK_RF_PHYS
/* referenced by adi.c */
#define SPRD_MISC_PHYS                                  SPRD_AON_PERI_ADI_MST_PHYS
/* referenced by serial_sc8800x.c */
#define ARM_UART0_BASE				                    SPRD_UART0_TOP_PHYS
#define ARM_UART1_BASE                                  SPRD_UART0_TOP_PHYS
/* referenced by fdl_main.c */
#define USB_REG_BASE                                    SPRD_USB3_1_PHYS
/* referenced by efuse.c */
#define SPRD_UIDEFUSE_PHYS                              SPRD_AON_PERI_EFUSE_TOP_WRAP_PHYS
/* referenced by sprd_timer.c */
