...
#define REG_AP_AHB_NANC_CLK_CFG                           SCI_ADDR(REGS_AP_AHB_BASE, 0x0060)
#define REG_AP_AHB_BOOT_MODE                              SCI_ADDR(REGS_AP_AHB_BASE, 0x0068)
#define REG_AP_AHB_RES_REG0                               SCI_ADDR(REGS_AP_AHB_BASE, 0x00F0)
...
/* bits definitions for register REG_AP_AHB_BOOT_MODE */
...
/* bits definitions for register REG_AP_AHB_RES_REG0 */
#define BITS_RES_REG0(_X_)                                ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
