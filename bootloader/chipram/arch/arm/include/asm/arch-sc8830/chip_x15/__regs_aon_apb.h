...
#define REG_AON_APB_DCXO_LC_REG0                          SCI_ADDR(REGS_AON_APB_BASE, 0x00C8)
#define REG_AON_APB_DCXO_LC_REG1                          SCI_ADDR(REGS_AON_APB_BASE, 0x00CC)
#define REG_AON_APB_WTG_TEST                              SCI_ADDR(REGS_AON_APB_BASE, 0x00D0)
#define REG_AON_APB_GPS_26M_REF_SEL                       SCI_ADDR(REGS_AON_APB_BASE, 0x00D4)
...
#define BIT_AON_GPIO_SOFT_RST                             ( BIT(3) )
...
#define BITS_MPLLN(_X_)                                   ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BITS_DPLLN(_X_)                                   ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BITS_TDPLLN(_X_)                                  ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BITS_CPLLN(_X_)                                   ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BITS_WIFIPLL1N(_X_)                               ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BITS_WIFIPLL2N(_X_)                               ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BITS_WPLLN(_X_)                                   ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
#define BIT_BB_REF_AUTO_PD_EN                             ( BIT(14) )
...
#define BITS_AON_RES_REG0(_X_)                            ( (_X_) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BITS_DDR_DLL_LOCK_WAIT(_X_)                       ( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_RES_REG2(_X_)                                ( (_X_) << 10 & (BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_BB_LDO_AUTO_EN                                ( BIT(9) )
#define BIT_BB_BG_AUTO_EN                                 ( BIT(8) )
#define BIT_ANA_INT_POL_SEL                               ( BIT(7) )
#define BIT_XTLBUF_COMB_POL_SEL                           ( BIT(6) )
#define BIT_XTLBUF2_COMB_EN                               ( BIT(5) )
#define BIT_XTLBUF1_COMB_EN                               ( BIT(4) )
#define BIT_EXT_XTL3_COMB_EN                              ( BIT(3) )
#define BIT_EXT_XTL2_COMB_EN                              ( BIT(2) )
#define BIT_EXT_XTL1_COMB_EN                              ( BIT(1) )
#define BIT_EXT_XTL0_COMB_EN                              ( BIT(0) )
...
/* bits definitions for register REG_AON_APB_WTG_TEST */
#define BIT_TG_DAC_OUT_SEL                                ( BIT(8) )
#define BITS_WTG_TEST(_X_)                                ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_AON_APB_GPS_26M_REF_SEL */
#define BIT_XTLBUF1_GPS_SEL                               ( BIT(2) )
#define BIT_XTLBUF0_GPS_SEL                               ( BIT(1) )
#define BIT_GPS_26M_REF_SEL                               ( BIT(0) )
