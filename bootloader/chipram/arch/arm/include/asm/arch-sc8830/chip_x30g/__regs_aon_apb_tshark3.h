/* the head file modifier:     ang   2015-01-21 14:32:21*/
...
#define REG_AON_APB_ANALOG_STATUS			SCI_ADDR(REGS_AON_APB_BASE, 0x3090)/*ANALOG_STATUS*/
#define REG_AON_APB_AON_CHIP_ID				SCI_ADDR(REGS_AON_APB_BASE, 0x00FC)/*AON_CHIP_ID*/
#define REG_AON_APB_RPLL_CFG				SCI_ADDR(REGS_AON_APB_BASE, 0x3094)
#define REG_AON_APB_RPLL_CFG1				SCI_ADDR(REGS_AON_APB_BASE, 0x3098)
...
#define BIT_CRYPTO_EB						( BIT(15) )
#define BIT_CODEC_EB						( BIT(14) )
...
/* bits definitions for register REG_AON_APB_ANALOG_STATUS */
#define BIT_RPLL_PD						( BIT(22) )
#define BIT_EFS0_PD						( BIT(21) )
#define BIT_THM_PD						( BIT(20) )
#define BIT_LVDS_PLL_PD						( BIT(19) )
#define BIT_LVDS_TX_PD						( BIT(18) )
#define BIT_CPLL_PD						( BIT(17) )
#define BIT_TDPLL_PD						( BIT(16) )
#define BIT_WPLL_PD						( BIT(15) )
#define BIT_DPLL_PD						( BIT(14) )
#define BIT_MPLL_PD						( BIT(13) )
#define BIT_REC_26MHZ_1_BUF_PD					( BIT(12) )
#define BIT_REC_26MHZ_0_BUF_PD					( BIT(11) )
#define BIT_WIFIPLL2_PD						( BIT(10) )
#define BIT_WIFIPLL1_PD						( BIT(9) )
#define BIT_WBT_DAC_PD						( BIT(8) )
#define BIT_BT_SARAD_PD						( BIT(7) )
#define BIT_WIFI_SARAD_PD					( BIT(6) )
#define BIT_BB_LDO_PD						( BIT(5) )
#define BIT_BB_BG_PD						( BIT(4) )
#define BIT_WG_AAPC_PD						( BIT(3) )
#define BIT_WG_AAFC_PD						( BIT(2) )
#define BIT_WG_DAC_PD						( BIT(1) )
#define BIT_WG_SARAD_PD						( BIT(0) )

/* bits definitions for register REG_AON_APB_AON_CHIP_ID */
#define BITS_AON_CHIP_ID(_X_)					(_X_)

/* bits definitions for register REG_AON_APB_RPLL_CFG */
#define BITS_RPLL_POSTDIV(_X_)					( (_X_) << 26 & (BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BITS_RPLL_REFIN(_X_)					( (_X_) << 24 & (BIT(24)|BIT(25)) )
#define BITS_RPLL_LPF(_X_)					( (_X_) << 20 & (BIT(20)|BIT(21)|BIT(22)) )
#define BITS_RPLL_IBIAS(_X_)					( (_X_) << 16 & (BIT(16)|BIT(17)) )
#define BITS_RPLL_N(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )

/* bits definitions for register REG_AON_APB_RPLL_CFG1 */
#define BITS_RPLL_KINT(_X_)					( (_X_) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_RPLL_DIV_S						( BIT(10) )
#define BITS_RPLL_RSV(_X_)					( (_X_) << 8 & (BIT(8)|BIT(9)) )
#define BIT_RPLL_MOD_EN						( BIT(7) )
#define BIT_RPLL_SDM_EN						( BIT(6) )
#define BITS_RPLL_NINT(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)) )
