...
#define REG_PMU_APB_PD_CP0_CEVA_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x003C)
#define REG_PMU_APB_PD_CP0_SYS_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0044)
#define REG_PMU_APB_PD_CP1_ARM9_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0048)
#define REG_PMU_APB_PD_CP1_GSM_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x004C)
#define REG_PMU_APB_PD_CP1_TD_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x0050)
#define REG_PMU_APB_PD_CP1_L1RAM_CFG                      SCI_ADDR(REGS_PMU_APB_BASE, 0x0054)
#define REG_PMU_APB_PD_CP1_SYS_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0058)
#define REG_PMU_APB_PD_CP2_ARM9_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x005C)
#define REG_PMU_APB_PD_CP2_WIFI_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0060)
#define REG_PMU_APB_AP_WAKEUP_POR_CFG                     SCI_ADDR(REGS_PMU_APB_BASE, 0x0064)
#define REG_PMU_APB_PD_CP2_SYS_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0068)
#define REG_PMU_APB_PD_PUB_SYS_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x006C)
...
#define REG_PMU_APB_XTL2_REL_CFG                          SCI_ADDR(REGS_PMU_APB_BASE, 0x0088)
...
#define REG_PMU_APB_TDPLL_REL_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x009C)
#define REG_PMU_APB_WPLL_REL_CFG                          SCI_ADDR(REGS_PMU_APB_BASE, 0x00A0)
#define REG_PMU_APB_CPLL_REL_CFG                          SCI_ADDR(REGS_PMU_APB_BASE, 0x00A4)
#define REG_PMU_APB_WIFIPLL1_REL_CFG                      SCI_ADDR(REGS_PMU_APB_BASE, 0x00A8)
#define REG_PMU_APB_WIFIPLL2_REL_CFG                      SCI_ADDR(REGS_PMU_APB_BASE, 0x00AC)
...
#define REG_PMU_APB_CP_SLP_STATUS_DBG1                    SCI_ADDR(REGS_PMU_APB_BASE, 0x00B8)
...
#define REG_PMU_APB_PWR_STATUS3_DBG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x00C8)
...
#define REG_PMU_APB_PLL_DIV_AUTO_GATE_EN                  SCI_ADDR(REGS_PMU_APB_BASE, 0x00D8)
#define REG_PMU_APB_PLL_DIV_EN1                           SCI_ADDR(REGS_PMU_APB_BASE, 0x00DC)
#define REG_PMU_APB_PLL_DIV_EN2                           SCI_ADDR(REGS_PMU_APB_BASE, 0x00E0)
...
#define REG_PMU_APB_BISR_CFG                              SCI_ADDR(REGS_PMU_APB_BASE, 0x0100)
#define REG_PMU_APB_CGM_AP_AUTO_GATE_EN                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0104)
#define REG_PMU_APB_CGM_GPU_MM_AUTO_GATE_EN               SCI_ADDR(REGS_PMU_APB_BASE, 0x0108)
#define REG_PMU_APB_CGM_CP0_AUTO_GATE_EN                  SCI_ADDR(REGS_PMU_APB_BASE, 0x010C)
#define REG_PMU_APB_CGM_CP1_AUTO_GATE_EN                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0110)
#define REG_PMU_APB_CGM_CP2_AUTO_GATE_EN                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0114)
#define REG_PMU_APB_CGM_AP_EN                             SCI_ADDR(REGS_PMU_APB_BASE, 0x0118)
#define REG_PMU_APB_CGM_GPU_MM_EN                         SCI_ADDR(REGS_PMU_APB_BASE, 0x011C)
#define REG_PMU_APB_CGM_CP0_EN                            SCI_ADDR(REGS_PMU_APB_BASE, 0x0120)
#define REG_PMU_APB_CGM_CP1_EN                            SCI_ADDR(REGS_PMU_APB_BASE, 0x0124)
#define REG_PMU_APB_CGM_CP2_EN                            SCI_ADDR(REGS_PMU_APB_BASE, 0x0128)
...
#define REG_PMU_APB_MEM_PD_CFG0                           SCI_ADDR(REGS_PMU_APB_BASE, 0x0138)
#define REG_PMU_APB_MEM_PD_CFG1                           SCI_ADDR(REGS_PMU_APB_BASE, 0x013C)
#define REG_PMU_APB_PD_DDR_PUBL_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0140)
#define REG_PMU_APB_PD_DDR_PHY_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0144)
#define REG_PMU_APB_BISR_CFG2                             SCI_ADDR(REGS_PMU_APB_BASE, 0x0148)
