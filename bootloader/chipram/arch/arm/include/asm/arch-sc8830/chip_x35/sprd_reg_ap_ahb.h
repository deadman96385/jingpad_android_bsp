...
#define REG_AP_AHB_AHB_RST                SCI_ADDR(SPRD_AHB_PHYS, 0x0004)
#define REG_AP_AHB_CA7_RST_SET            SCI_ADDR(SPRD_AHB_PHYS, 0x0008)
#define REG_AP_AHB_CA7_CKG_CFG            SCI_ADDR(SPRD_AHB_PHYS, 0x000C)
#define REG_AP_AHB_MCU_PAUSE              SCI_ADDR(SPRD_AHB_PHYS, 0x0010)
#define REG_AP_AHB_MISC_CKG_EN            SCI_ADDR(SPRD_AHB_PHYS, 0x0014)
#define REG_AP_AHB_MISC_CFG               SCI_ADDR(SPRD_AHB_PHYS, 0x0018)
#define REG_AP_AHB_AP_MTX_S3_PRIO0        SCI_ADDR(SPRD_AHB_PHYS, 0x001C)
#define REG_AP_AHB_AP_MTX_S3_PRIO1        SCI_ADDR(SPRD_AHB_PHYS, 0x0020)
#define REG_AP_AHB_AP_MTX_S3_PRIO2        SCI_ADDR(SPRD_AHB_PHYS, 0x0024)
#define REG_AP_AHB_AP_MTX_S2_PRIO0        SCI_ADDR(SPRD_AHB_PHYS, 0x0028)
#define REG_AP_AHB_AP_MTX_S1_PRIO0        SCI_ADDR(SPRD_AHB_PHYS, 0x002C)
#define REG_AP_AHB_AP_MTX_S0_PRIO0        SCI_ADDR(SPRD_AHB_PHYS, 0x0030)
#define REG_AP_AHB_AP_MTX_S0_PRIO1        SCI_ADDR(SPRD_AHB_PHYS, 0x0034)
#define REG_AP_AHB_AP_MTX_S0_PRIO2        SCI_ADDR(SPRD_AHB_PHYS, 0x0038)
#define REG_AP_AHB_AP_SYS_FORCE_SLEEP_CFG SCI_ADDR(SPRD_AHB_PHYS, 0x003C)
#define REG_AP_AHB_AP_SYS_AUTO_SLEEP_CFG  SCI_ADDR(SPRD_AHB_PHYS, 0x0040)
#define REG_AP_AHB_AP_MAIN_MTX_HPROT_CFG  SCI_ADDR(SPRD_AHB_PHYS, 0x0044)
#define REG_AP_AHB_CA7_STANDBY_STATUS     SCI_ADDR(SPRD_AHB_PHYS, 0x0048)
#define REG_AP_AHB_HOLDING_PEN            SCI_ADDR(SPRD_AHB_PHYS, 0x004C)
#define REG_AP_AHB_JMP_ADDR_CA7_C0        SCI_ADDR(SPRD_AHB_PHYS, 0x0050)
#define REG_AP_AHB_JMP_ADDR_CA7_C1        SCI_ADDR(SPRD_AHB_PHYS, 0x0054)
#define REG_AP_AHB_JMP_ADDR_CA7_C2        SCI_ADDR(SPRD_AHB_PHYS, 0x0058)
#define REG_AP_AHB_JMP_ADDR_CA7_C3        SCI_ADDR(SPRD_AHB_PHYS, 0x005C)
#define REG_AP_AHB_CHIP_ID                SCI_ADDR(SPRD_AHB_PHYS, 0x00FC)
