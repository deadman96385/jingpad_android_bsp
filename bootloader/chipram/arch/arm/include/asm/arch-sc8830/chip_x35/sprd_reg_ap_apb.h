...
#define REG_AP_APB_APB_EB               SCI_ADDR(SPRD_APBREG_PHYS, 0x0000)
#define REG_AP_APB_APB_RST              SCI_ADDR(SPRD_APBREG_PHYS, 0x0004)
#define REG_AP_APB_USB_PHY_TUNE         SCI_ADDR(SPRD_APBREG_PHYS, 0x0008)
#define REG_AP_APB_USB_PHY_TEST         SCI_ADDR(SPRD_APBREG_PHYS, 0x000C)
#define REG_AP_APB_USB_PHY_CTRL         SCI_ADDR(SPRD_APBREG_PHYS, 0x0010)
#define REG_AP_APB_APB_MISC_CTRL        SCI_ADDR(SPRD_APBREG_PHYS, 0x0014)
