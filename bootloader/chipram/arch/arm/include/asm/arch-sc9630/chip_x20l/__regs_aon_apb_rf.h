...
#define REG_AON_APB_CA7_RST_MONITOR                     SCI_ADDR(REGS_AON_APB_BASE, 0x3038)/*CA7_RST_MONITOR*/
...
/* bits definitions for register REG_AON_APB_RF_APB_EB1 */
...
//#define BIT_VBC_INT_CP0_ARM_SEL                           ( BIT(3) ) /*not used*/
//#define BIT_VBC_INT_CP1_ARM_SEL                           ( BIT(2) ) /*not used*/
//#define BIT_VBC_DMA_CP0_ARM_SEL                           ( BIT(1) ) /*not used*/
//#define BIT_VBC_DMA_CP1_ARM_SEL                           ( BIT(0) ) /*not used*/
...
/* bits definitions for register REG_AON_APB_RF_ARM7_CFG_BUS */
...
/* bits definitions for register REG_AON_APB_RF_AP_WPROT_EN1 */
#define BITS_AP_AWADDR_WPROT_EN1(_X_)                     (_X_)

/* bits definitions for register REG_AON_APB_RF_CP0_WPROT_EN1 */
#define BITS_CP0_AWADDR_WPROT_EN1(_X_)                    (_X_)

/* bits definitions for register REG_AON_APB_RF_CP1_WPROT_EN1 */
...
/* bits definitions for register REG_AON_APB_RF_PLL_LOCK_OUT_SEL */
