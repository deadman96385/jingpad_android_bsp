/* the head file modifier:     g   2015-03-19 15:30:08*/
...
#define REG_AON_APB_PLD_ID_0				SCI_ADDR(REGS_AON_APB_BASE, 0x00E0)/*PLD_ID_0*/
#define REG_AON_APB_PLD_ID_1				SCI_ADDR(REGS_AON_APB_BASE, 0x00E4)/*PLD_ID_1*/
#define REG_AON_APB_PROJ_ID_0			SCI_ADDR(REGS_AON_APB_BASE, 0x00E8)/*PROJ_ID_0*/
#define REG_AON_APB_PROJ_ID_1			SCI_ADDR(REGS_AON_APB_BASE, 0x00EC)/*PROJ_ID_1*/
#define REG_AON_APB_DERIVED_ID			SCI_ADDR(REGS_AON_APB_BASE, 0x00F4)/*DERIVED_ID*/
#define REG_AON_APB_MANU_ID				SCI_ADDR(REGS_AON_APB_BASE, 0x00F8)/*MANU_ID*/
#define REG_AON_APB_IMP_ID				SCI_ADDR(REGS_AON_APB_BASE, 0x00FC)/*IMP_ID*/
...
#define REG_AON_APB_AP_SDISABLE			SCI_ADDR(REGS_AON_APB_BASE, 0x013C)/*APCPU_SDISABLE*/
#define REG_AON_APB_MPLL0_CFG1			SCI_ADDR(REGS_AON_APB_BASE, 0x0140)/*MPLL0_CFG1*/
#define REG_AON_APB_MPLL0_CFG2			SCI_ADDR(REGS_AON_APB_BASE, 0x0144)/*MPLL0_CFG2*/
#define REG_AON_APB_GPLL_CFG1			SCI_ADDR(REGS_AON_APB_BASE, 0x0148)/*GPLL_CFG1*/
#define REG_AON_APB_GPLL_CFG2			SCI_ADDR(REGS_AON_APB_BASE, 0x014C)/*GPLL_CFG2*/
#define REG_AON_APB_UPLL_CFG1			SCI_ADDR(REGS_AON_APB_BASE, 0x0150)/*UPLL_CFG1*/
#define REG_AON_APB_UPLL_CFG2			SCI_ADDR(REGS_AON_APB_BASE, 0x0154)/*UPLL_CFG2*/
#define REG_AON_APB_APCPU_CCI_CKG_CFG		SCI_ADDR(REGS_AON_APB_BASE, 0x0158)/*APCPU_CCI_CKG_CFG*/
#define REG_AON_APB_AP_MODULE_FOLLOW_CTRL		SCI_ADDR(REGS_AON_APB_BASE, 0x15C)/*AP_MODULE_FOLLOW_CTRL*/
#define REG_AON_APB_AVS_SOFT_RST			SCI_ADDR(REGS_AON_APB_BASE, 0x0160)/*AVS_SOFT_RST*/
#define REG_AON_APB_AP_IRAM_REMAP			SCI_ADDR(REGS_AON_APB_BASE, 0x0164)/*AP_IRAM_REMAP*/
#define REG_AON_APB_APCPU_BIG_SOFT_RST		SCI_ADDR(REGS_AON_APB_BASE, 0x0168)/*APCPU_BIG_SOFT_RST*/
#define REG_AON_APB_APCPU_LIT_SOFT_RST		SCI_ADDR(REGS_AON_APB_BASE, 0x016c)/*APCPU_LIT_SOFT_RST*/
#define REG_AON_APB_APCPU_TOP_SOFT_RST		SCI_ADDR(REGS_AON_APB_BASE, 0x0170)/*APCPU_TOP_SOFT_RST*/
#define REG_AON_APB_CA5_BIG_THM_CTRL			SCI_ADDR(REGS_AON_APB_BASE, 0x01A0)/*CA5_BIG_THM_CTRL*/
#define REG_AON_APB_CA5_LIT_THM_CTRL			SCI_ADDR(REGS_AON_APB_BASE, 0x01A4)/*CA5_LIT_THM_CTRL*/
#define REG_AON_APB_A53_BIGCORE_VDROP SNSR_CTRL	SCI_ADDR(REGS_AON_APB_BASE, 0x01A8)/*A53_BIGCORE_VDROP SNSR_CTRL*/
#define REG_AON_APB_A53_LITCORE_VDROP SNSR_CTRL	SCI_ADDR(REGS_AON_APB_BASE, 0x01AC)/*A53_LITCORE_VDROP SNSR_CTRL*/
#define REG_AON_APB_A53_AUTO_REG_SAVE_CRTL		SCI_ADDR(REGS_AON_APB_BASE, 0x01B0)/*A53_AUTO_REG_SAVE_CRTL*/
#define REG_AON_APB_CSSYS_CFG			SCI_ADDR(REGS_AON_APB_BASE, 0x01B4)/*CSSYS_CFG*/
#define REG_AON_APB_REDUN_CFG			SCI_ADDR(REGS_AON_APB_BASE, 0x01B8)/*REDUN_CFG*/
...
#define BIT_CODEC_EB						( BIT(31) )
#define BIT_CSSYS_EB						( BIT(30) )
#define BIT_CA53_LIT_AVS_EB					( BIT(29) )
#define BIT_CA53_BIG_AVS_EB					( BIT(28) )
...
#define BIT_CA53_BIG_THMA_RTC_EB				( BIT(20) )
...
#define BIT_CA53_LIT_THMA_RTC_EB				( BIT(11) )
...
#define BIT_GPLL_SOFT_CNT_DONE					( BIT(6) )
#define BIT_MPLL_SOFT_CNT_DONE					( BIT(5) )
...
/* bits definitions for register REG_AON_APB_PLD_ID_0 */
#define BITS_PLD_ID_0(_X_)					(_X_)

/* bits definitions for register REG_AON_APB_PLD_ID_1 */
#define BITS_PLD_ID_1(_X_)					(_X_)

/* bits definitions for register REG_AON_APB_PROJ_ID_0 */
#define BITS_PROJ_ID_0(_X_)					(_X_)

/* bits definitions for register REG_AON_APB_PROJ_ID_1 */
#define BITS_PROJ_ID_1(_X_)					(_X_)

/* bits definitions for register REG_AON_APB_DERIVED_ID */
#define BITS_DERIVED_ID(_X_)					( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_MF_ID(_X_)						( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_AON_APB_MANU_ID */
#define BITS_PROCESS_ID(_X_)					( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_FOUNDRY_ID(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_AON_APB_IMP_ID */
#define BITS_MEM_CMP(_X_)					( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_STD_CELL(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
...
#define BITS_OSC_CTRL_SEL(_X_)					( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
...
/* bits definitions for register REG_AON_APB_APCPU_SDISABLE */
#define BITS_APCPU_BIG_CP15SDISABLE(_X_)			( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BIT_APCPU_CFGSDISABLE					( BIT(4) )
#define BITS_APCPU_LIT_CP15SDISABLE(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_AON_APB_MPLL0_CFG1 */
#define BITS_MPLL0_RES(_X_)					( (_X_) << 28 & (BIT(28)|BIT(29)|BIT(30)) )
#define BIT_MPLL0_LOCK_DONE					( BIT(27) )
#define BIT_MPLL0_DIV_S						( BIT(26) )
#define BIT_MPLL0_MOD_EN					( BIT(25) )
#define BIT_MPLL0_SDM_EN					( BIT(24) )
#define BITS_MPLL0_LPF(_X_)					( (_X_) << 20 & (BIT(20)|BIT(21)|BIT(22)) )
#define BITS_MPLL0_REFIN(_X_)					( (_X_) << 18 & (BIT(18)|BIT(19)) )
#define BITS_MPLL0_IBIAS(_X_)					( (_X_) << 16 & (BIT(16)|BIT(17)) )
#define BITS_MPLL0_N(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )

/* bits definitions for register REG_AON_APB_MPLL0_CFG2 */
#define BITS_MPLL0_NINT(_X_)					( (_X_) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BITS_MPLL0_KINT(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )

/* bits definitions for register REG_AON_APB_GPLL_CFG1 */
#define BITS_GPLL_RES(_X_)					( (_X_) << 28 & (BIT(28)|BIT(29)|BIT(30)) )
#define BIT_GPLL_LOCK_DONE					( BIT(27) )
#define BIT_GPLL_DIV_S						( BIT(26) )
#define BIT_GPLL_MOD_EN						( BIT(25) )
#define BIT_GPLL_SDM_EN						( BIT(24) )
#define BITS_GPLL_LPF(_X_)					( (_X_) << 20 & (BIT(20)|BIT(21)|BIT(22)) )
#define BITS_GPLL_REFIN(_X_)					( (_X_) << 18 & (BIT(18)|BIT(19)) )
#define BITS_GPLL_IBIAS(_X_)					( (_X_) << 16 & (BIT(16)|BIT(17)) )
#define BITS_GPLL_N(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )

/* bits definitions for register REG_AON_APB_GPLL_CFG2 */
#define BITS_GPLL_NINT(_X_)					( (_X_) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BITS_GPLL_KINT(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )

/* bits definitions for register REG_AON_APB_UPLL_CFG1 */
#define BITS_UPLL_RES(_X_)					( (_X_) << 28 & (BIT(28)|BIT(29)|BIT(30)) )
#define BIT_UPLL_LOCK_DONE					( BIT(27) )
#define BIT_UPLL_DIV_S						( BIT(26) )
#define BIT_UPLL_MOD_EN						( BIT(25) )
#define BIT_UPLL_SDM_EN						( BIT(24) )
#define BITS_UPLL_LPF(_X_)					( (_X_) << 20 & (BIT(20)|BIT(21)|BIT(22)) )
#define BITS_UPLL_REFIN(_X_)					( (_X_) << 18 & (BIT(18)|BIT(19)) )
#define BITS_UPLL_IBIAS(_X_)					( (_X_) << 16 & (BIT(16)|BIT(17)) )
#define BITS_UPLL_N(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )

/* bits definitions for register REG_AON_APB_UPLL_CFG2 */
#define BITS_UPLL_NINT(_X_)					( (_X_) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BITS_UPLL_KINT(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )

/* bits definitions for register REG_AON_APB_APCPU_CCI_CKG_CFG */
#define BIT_APCPU_CCI_CKG_EN					( BIT(1) )
#define BIT_APCPU_CCI_AUTO_GATE_EN				( BIT(0) )

/* bits definitions for register REG_AON_APB_AP_MODULE_FOLLOW_CTRL */
#define BIT_AP_GPU_CLK_FOLLOW_AP				( BIT(2) )
#define BIT_AP_MM_CODEC_CLK_FOLLOW_AP				( BIT(1) )
#define BIT_AP_MM_CLK_FOLLOW_AP					( BIT(0) )

/* bits definitions for register REG_AON_APB_AVS_SOFT_RST */
#define BIT_CA53_LIT_AVS_SOFT_RST				( BIT(2) )
#define BIT_CA53_BIG_AVS_SOFT_RST				( BIT(1) )
#define BIT_GPU_AVS_SOFT_RST					( BIT(0) )

/* bits definitions for register REG_AON_APB_AP_IRAM_REMAP */
#define BIT_AP_IRAM_REMAP					( BIT(0) )

/* bits definitions for register REG_AON_APB_APCPU_BIG_SOFT_RST */
#define BIT_APCPU_BIG_DBG_SOFT_RST				( BIT(9) )
#define BIT_APCPU_BIG_L2_SOFT_RST				( BIT(8) )
#define BITS_APCPU_BIG_ATB_SOFT_RST(_X_)			( (_X_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_APCPU_BIG_CORE_SOFT_RST(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_AON_APB_APCPU_LIT_SOFT_RST */
#define BIT_APCPU_LIT_DBG_SOFT_RST				( BIT(9) )
#define BIT_APCPU_LIT_L2_SOFT_RST				( BIT(8) )
#define BITS_APCPU_LIT_ATB_SOFT_RST(_X_)			( (_X_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_APCPU_LIT_CORE_SOFT_RST(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_AON_APB_APCPU_TOP_SOFT_RST */
#define BIT_APCPU_MTX_SOFT_RST					( BIT(2) )
#define BIT_APCPU_EMC_SOFT_RST					( BIT(1) )
#define BIT_APCPU_DAP_SOFT_RST					( BIT(0) )

/* bits definitions for register REG_AON_APB_CA5_BIG_THM_CTRL */
#define BITS_CA53_BIG_THM_CALI_RSVD(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_AON_APB_CA5_LIT_THM_CTRL */
#define BITS_CA53_LIT_THM_CALI_RSVD(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_AON_APB_A53_BIGCORE_VDROP SNSR_CTRL */
#define BITS_CA53_BIG_VDROP1_RESERVED_CTRL(_X_)			( (_X_) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
#define BITS_CA53_BIG_VDROP1_CTRL(_X_)				( (_X_) << 22 & (BIT(22)|BIT(23)) )
#define BITS_CA53_BIG_VDROP1_CURRENT_CTRL(_X_)			( (_X_) << 20 & (BIT(20)|BIT(21)) )
#define BIT_CA53_BIG_VDROP1_OUT					( BIT(17) )
#define BIT_CA53_BIG_VDROP1_EN					( BIT(16) )
#define BITS_CA53_BIG_VDROP0_RESERVED_CTRL(_X_)			( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BITS_CA53_BIG_VDROP0_CTRL(_X_)				( (_X_) << 6 & (BIT(6)|BIT(7)) )
#define BITS_CA53_BIG_VDROP0_CURRENT_CTRL(_X_)			( (_X_) << 4 & (BIT(4)|BIT(5)) )
#define BIT_CA53_BIG_VDROP0_OUT					( BIT(1) )
#define BIT_CA53_BIG_VDROP0_EN					( BIT(0) )

/* bits definitions for register REG_AON_APB_A53_LITCORE_VDROP SNSR_CTRL */
#define BITS_CA53_LIT_VDROP1_RESERVED_CTRL(_X_)			( (_X_) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
#define BITS_CA53_LIT_VDROP1_CTRL(_X_)				( (_X_) << 22 & (BIT(22)|BIT(23)) )
#define BITS_CA53_LIT_VDROP1_CURRENT_CTRL(_X_)			( (_X_) << 20 & (BIT(20)|BIT(21)) )
#define BIT_CA53_LIT_VDROP1_OUT					( BIT(17) )
#define BIT_CA53_LIT_VDROP1_EN					( BIT(16) )
#define BITS_CA53_LIT_VDROP0_RESERVED_CTRL(_X_)			( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BITS_CA53_LIT_VDROP0_CTRL(_X_)				( (_X_) << 6 & (BIT(6)|BIT(7)) )
#define BITS_CA53_LIT_VDROP0_CURRENT_CTRL(_X_)			( (_X_) << 4 & (BIT(4)|BIT(5)) )
#define BIT_CA53_LIT_VDROP0_OUT					( BIT(1) )
#define BIT_CA53_LIT_VDROP0_EN					( BIT(0) )

/* bits definitions for register REG_AON_APB_A53_AUTO_REG_SAVE_CRTL */
#define BIT_APCPU_AUTO_REG_SAVE_TRIG_SEL			( BIT(1) )
#define BIT_AUTO_REG_SAVE_EN					( BIT(0) )

/* bits definitions for register REG_AON_APB_CSSYS_CFG */
#define BIT_CSSYS_TPIU_TPCTL					( BIT(0) )

/* bits definitions for register REG_AON_APB_REDUN_CFG */
#define BIT_REDUN_CFG_3						( BIT(3) )
#define BIT_REDUN_CFG_2						( BIT(2) )
#define BIT_REDUN_CFG_1						( BIT(1) )
#define BIT_REDUN_CFG_0						( BIT(0) )
...
/* bits definitions for register REG_AON_APB_APCPU_RST_MONITOR */
