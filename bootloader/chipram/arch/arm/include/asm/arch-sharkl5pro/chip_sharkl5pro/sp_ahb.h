...
#define CTL_BASE_SP_AHB 0x51000000
...
#define REG_SP_AHB_AHB_MTX_CTL3              ( CTL_BASE_SP_AHB + 0x004C )
#define REG_SP_AHB_AHB_MTX_CTL4              ( CTL_BASE_SP_AHB + 0x0050 )
...
#define BIT_SP_AHB_PRI_M0TOS1_RND_THR(x)     (((x) & 0xF) << 11)
#define BIT_SP_AHB_PRI_M0TOS1_RND_EN         BIT(10)
#define BIT_SP_AHB_PRI_M0TOS1_SEL(x)         (((x) & 0x3) << 8)
...
#define BIT_SP_AHB_PRI_M1TOS1_RND_THR(x)     (((x) & 0xF) << 19)
#define BIT_SP_AHB_PRI_M1TOS1_RND_EN         BIT(18)
#define BIT_SP_AHB_PRI_M1TOS1_SEL(x)         (((x) & 0x3) << 16)
