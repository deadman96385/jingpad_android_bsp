...
#define REG_PMU_APB_PD_CAM_CORE_PWR_CFG                        ( CTL_BASE_PMU_APB + 0x0088 )
...
#define REG_PMU_APB_LPLL1_REL_CFG                              ( CTL_BASE_PMU_APB + 0x00E8 )
...
#define REG_PMU_APB_CPPLL_REL_CFG                              ( CTL_BASE_PMU_APB + 0x00FC )
...
#define REG_PMU_APB_PD_CAM_CORE_SHUTDOWN_MARK_STATUS           ( CTL_BASE_PMU_APB + 0x02B4 )
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_CAM_CORE_PWR_CFG
// Register Offset : 0x0088
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_CAM_CORE_DBG_SHUTDOWN_EN                                         BIT(28)
#define BIT_PMU_APB_PD_CAM_CORE_FORCE_SHUTDOWN                                          BIT(25)
#define BIT_PMU_APB_PD_CAM_CORE_AUTO_SHUTDOWN_EN                                        BIT(24)
#define BIT_PMU_APB_PD_CAM_CORE_PWR_ON_DLY(x)                                           (((x) & 0xFF) << 16)
#define BIT_PMU_APB_PD_CAM_CORE_PWR_ON_SEQ_DLY(x)                                       (((x) & 0xFF) << 8)
#define BIT_PMU_APB_PD_CAM_CORE_ISO_ON_DLY(x)                                           (((x) & 0xFF))
...
#define BIT_PMU_APB_PD_VSP_CORE_PWR_ON_SEQ_DLY(x)                                       (((x) & 0xFF) << 8)
...
#define BIT_PMU_APB_LPLL1_WAIT_CNT(x)                                                   (((x) & 0xFF) << 8)
...
#define BIT_PMU_APB_CPPLL_WAIT_CNT(x)                                                   (((x) & 0xFF) << 8)
...
#define BIT_PMU_APB_GPLL_AGCP_SYS_SEL                                                   BIT(5)
...
#define BIT_PMU_APB_DPLL1_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_XTLBUF2_AGCP_SYS_SEL                                                BIT(5)
...
#define BIT_PMU_APB_DPLL0_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_MPLL0_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_XTLBUF1_AGCP_SYS_SEL                                                BIT(5)
...
#define BIT_PMU_APB_RPLL1_AGCP_SYS_SEL                                                  BIT(5)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_LPLL1_REL_CFG
// Register Offset : 0x00E8
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_LPLL1_FRC_ON                                                        BIT(15)
#define BIT_PMU_APB_LPLL1_FRC_OFF                                                       BIT(14)
#define BIT_PMU_APB_LPLL1_RELOCK_EN                                                     BIT(13)
#define BIT_PMU_APB_LPLL1_REF_SEL(x)                                                    (((x) & 0x7) << 10)
#define BIT_PMU_APB_LPLL1_AP_SYS_SEL                                                    BIT(8)
#define BIT_PMU_APB_LPLL1_WTLCP_SYS_SEL                                                 BIT(7)
#define BIT_PMU_APB_LPLL1_PUBCP_SYS_SEL                                                 BIT(6)
#define BIT_PMU_APB_LPLL1_AGCP_SYS_SEL                                                  BIT(5)
#define BIT_PMU_APB_LPLL1_CM4_SYS_SEL                                                   BIT(4)
#define BIT_PMU_APB_LPLL1_PUB0_SYS_SEL                                                  BIT(3)
#define BIT_PMU_APB_LPLL1_PUB1_SYS_SEL                                                  BIT(2)
#define BIT_PMU_APB_LPLL1_CAM_PD_SEL                                                    BIT(1)
#define BIT_PMU_APB_LPLL1_EXT_PD_SEL                                                    BIT(0)
...
#define BIT_PMU_APB_XTLBUF0_AGCP_SYS_SEL                                                BIT(5)
...
#define BIT_PMU_APB_MPLL1_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_MPLL2_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_TWPLL_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_CPPLL_FRC_ON                                                        BIT(15)
#define BIT_PMU_APB_CPPLL_FRC_OFF                                                       BIT(14)
#define BIT_PMU_APB_CPPLL_RELOCK_EN                                                     BIT(13)
#define BIT_PMU_APB_CPPLL_AP_SYS_SEL                                                    BIT(8)
#define BIT_PMU_APB_CPPLL_WTLCP_SYS_SEL                                                 BIT(7)
#define BIT_PMU_APB_CPPLL_PUBCP_SYS_SEL                                                 BIT(6)
#define BIT_PMU_APB_CPPLL_AGCP_SYS_SEL                                                  BIT(5)
#define BIT_PMU_APB_CPPLL_CM4_SYS_SEL                                                   BIT(4)
#define BIT_PMU_APB_CPPLL_PUB0_SYS_SEL                                                  BIT(3)
#define BIT_PMU_APB_CPPLL_PUB1_SYS_SEL                                                  BIT(2)
#define BIT_PMU_APB_CPPLL_CAM_PD_SEL                                                    BIT(1)
#define BIT_PMU_APB_CPPLL_EXT_PD_SEL                                                    BIT(0)
...
#define BIT_PMU_APB_RC_AGCP_SYS_SEL                                                     BIT(5)
...
#define BIT_PMU_APB_LPLL0_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_XTL0_AGCP_SYS_SEL                                                   BIT(5)
...
#define BIT_PMU_APB_RPLL0_AGCP_SYS_SEL                                                  BIT(5)
...
#define BIT_PMU_APB_PD_CAM_CORE_STATE(x)                                                (((x) & 0x1F) << 5)
...
#define BIT_PMU_APB_PD_CAM_CORE_BISR_DONE                                               BIT(19)
...
#define BIT_PMU_APB_PD_CAM_CORE_BISR_BUSY                                               BIT(19)
...
#define BIT_PMU_APB_PD_CAM_CORE_BISR_FORCE_BYP                                          BIT(19)
...
#define BIT_PMU_APB_PD_CAM_CORE_BISR_FORCE_EN                                           BIT(19)
...
#define BIT_PMU_APB_CPPLL_CNT_DONE                                                      BIT(12)
...
#define BIT_PMU_APB_LPLL1_CNT_DONE                                                      BIT(7)
...
#define BIT_PMU_APB_PD_CAM_CORE_ACK_D                                                   BIT(18)
...
#define BIT_PMU_APB_PD_CAM_CORE_ACK_M                                                   BIT(18)
...
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_PUB1_DFI_BUSMON_EN                    BIT(24)
...
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_HARDWARE_PUB1_DFS_EXIT_EN                 BIT(21)
...
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_PUB1_BUSMON_DMA_EN                    BIT(12)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_PUB0_DFS_ERROR_EN                     BIT(11)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_PUB1_DFS_ERROR_EN                     BIT(10)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_BIA_WDG_RESET_EN                      BIT(9)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_DMA_AGCP_EN                           BIT(8)
...
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_AGCP_DMA_CHN1_GRP1_EN                     BIT(3)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_AGCP_DMA_CHN1_GRP2_EN                     BIT(2)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_AGCP_DMA_CHN2_GRP1_EN                     BIT(1)
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_AGCP_DMA_CHN2_GRP2_EN                     BIT(0)
...
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_SP_TMR_EN                             BIT(21)
...
#define BIT_PMU_APB_CM4_SYS_WAKEUP_SOURCE_INT_REQ_BUSMON_AGCP_EN                        BIT(1)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_VBC_AUDPLY_AGCP_EN                     BIT(31)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_SRC44P1K_AGCP_EN                       BIT(30)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_AGCP_WDG_RST_EN                            BIT(26)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_WTLCP_TG_WDG_RST_EN                        BIT(25)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_AGCP_DMA_CHN1_GRP1_EN                      BIT(24)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_AGCP_DMA_CHN2_GRP1_EN                      BIT(23)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_AGCP_DMA_CHN1_GRP2_EN                      BIT(22)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_AGCP_DMA_CHN2_GRP2_EN                      BIT(21)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_WTLCP_LTE_WDG_RST_EN                       BIT(20)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_NOC_ERR_EN                             BIT(19)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_STATALARM_EN                           BIT(18)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_VPP_DEINT_EN                           BIT(8)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_DSI1_PLL_EN                            BIT(7)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_PME_GENERATION_PMU_EN                          BIT(3)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_DISP_MMU_PF_EN                         BIT(31)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_CPP_MMU_PF_EN                          BIT(26)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_GSP1_EN                                BIT(14)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_DISPC1_EN                              BIT(8)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_VBC_AUDRCD_AGCP_EN                     BIT(0)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_AP_USB3_EN                             BIT(22)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_UFS_EN                                 BIT(14)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_MCDT_AGCP_EN                           BIT(10)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_DMA_AGCP_EN                            BIT(9)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_GSP_MMU_EN                             BIT(24)
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_VSP_MMU_EN                             BIT(23)
...
#define BIT_PMU_APB_BASEIA_WAKEUP_SOURCE_INT_REQ_AP_I2C3_EN                             BIT(9)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_CAM_CORE_SHUTDOWN_MARK_STATUS
// Register Offset : 0x02B4
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_CAM_CORE_SHUTDOWN_MARK(x)                                        (((x) & 0xF))
