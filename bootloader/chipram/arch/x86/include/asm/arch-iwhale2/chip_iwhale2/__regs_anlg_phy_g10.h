...
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_CLK_CTRL_0          ( CTL_BASE_ANLG_PHY_G10 + 0x0000 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_MODU_CTRL_0         ( CTL_BASE_ANLG_PHY_G10 + 0x0004 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_DIV_CTRL_0          ( CTL_BASE_ANLG_PHY_G10 + 0x0008 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_PWR_CTRL_0          ( CTL_BASE_ANLG_PHY_G10 + 0x000C )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_ADC_CTRL_0          ( CTL_BASE_ANLG_PHY_G10 + 0x0010 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_ADC_DATA_0          ( CTL_BASE_ANLG_PHY_G10 + 0x0014 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_PLL_BIST_0          ( CTL_BASE_ANLG_PHY_G10 + 0x0018 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_WRAP_GLUE_CTRL      ( CTL_BASE_ANLG_PHY_G10 + 0x001C )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_DUMY_RW0            ( CTL_BASE_ANLG_PHY_G10 + 0x0020 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_DUMY_RO0            ( CTL_BASE_ANLG_PHY_G10 + 0x0024 )
#define REG_ANLG_PHY_G10_ANALOG_DPLL_THM_TOP_1_REG_SEL_CFG_0       ( CTL_BASE_ANLG_PHY_G10 + 0x0028 )
