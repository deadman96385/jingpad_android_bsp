...
int test_stuck_address(unsigned long volatile *bufa, ulv *bufb, size_t count);
...
#endif
int test_bitflip_comparison_tiger(unsigned long volatile *bufa, unsigned long volatile *bufb, size_t count);
