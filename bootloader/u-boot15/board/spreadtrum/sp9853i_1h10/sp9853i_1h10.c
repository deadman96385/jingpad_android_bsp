...
{
	int ver_id;
	ver_id = __raw_readl(REG_AON_APB_AON_VER_ID);
	if(ver_id <= 1){
		sci_glb_set(REG_AON_APB_THERMAL_OVERHEAT_EN,
					BIT_AON_APB_ITHM0_GPU_OVERHEAT_EN |
					BIT_AON_APB_ITHM1_BIA_OVERHEAT_EN);
	}else{
		sci_glb_set(REG_AON_APB_THERMAL_OVERHEAT_EN,
					BIT_AON_APB_DPLL_THM_OVERHEAT_EN |
					BIT_AON_APB_ITHM0_GPU_OVERHEAT_EN |
					BIT_AON_APB_ITHM1_BIA_OVERHEAT_EN);
	}
}
