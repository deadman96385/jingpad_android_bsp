...
{REG_PIN_UART_MATRIX_MTX_CFG,0x1750180C},//UART0->PUBCP_UART1;UART1->AP_UART1;UART2->PUBCP_UART0;UART3->wtlcp_wci2;UART4->CM4_UART0;UART5->CM4_UART1;UART6->TGDSP_UART0;--modified 20191021
...
{REG_MISC_PIN_SIMRST2,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//CHG_INT
...
{REG_MISC_PIN_SD2_CMD,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//CHG_EN'
{REG_PIN_SD2_D0,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_SD2_D0,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//CAMERA_FLASH_CHIPEN
...
{REG_MISC_PIN_SD2_D2,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//CAMERA_FLASH_SYNC
{REG_PIN_SD2_D3,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_SD2_D3,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//CAMERA_TORCH_EN
...
{REG_MISC_PIN_DNS_D0,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AUDCP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//Pro//DNS_D0
{REG_PIN_DNS_D1,                        BITS_PIN_AF(1)},
{REG_MISC_PIN_DNS_D1,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AUDCP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//Pro//DNS_D1
{REG_PIN_IIS3DI,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS3DI,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//Pro//COLOR_SENSOR_INT
{REG_PIN_IIS3DO,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS3DO,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//Pro//TOF_XSHUT
{REG_PIN_IIS3CLK,                       BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS3CLK,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//Pro//TOF_GPIO
{REG_PIN_IIS3LRCK,                      BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS3LRCK,                 BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//Pro//VDDCAMCORE_EN
{REG_PIN_GPIO116,                       BITS_PIN_AF(3)},
{REG_MISC_PIN_GPIO116,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//Pro//NC
...
{REG_MISC_PIN_RFCTL17,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//MIPI_SWITCH_SEL[RFCTL_16]
...
{REG_MISC_PIN_RFFE1_SCK,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//EAR_CTL1
{REG_PIN_RFFE1_SDA,                     BITS_PIN_AF(3)},
{REG_MISC_PIN_RFFE1_SDA,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//EAR_CTL2
...
{REG_MISC_PIN_GPIO84,                   BITS_PIN_DS(1)|BIT_PIN_WPUS|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_Z},//Pro//I2C7_SCL
{REG_PIN_GPIO85,                        BITS_PIN_AF(2)},
{REG_MISC_PIN_GPIO85,                   BITS_PIN_DS(1)|BIT_PIN_WPUS|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_Z},//Pro//I2C7_SDA
{REG_PIN_GPIO86,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_GPIO86,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_CM4|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//Pro//AG_INT0
{REG_PIN_GPIO87,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_GPIO87,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_CM4|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//Pro//AG_INT1
{REG_PIN_GPIO88,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_GPIO88,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_CM4|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//Pro//PROX_INT
...
{REG_MISC_PIN_IIS1CLK,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//LCM_SCOURCE_AVDDEN
{REG_PIN_IIS1LRCK,                      BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS1LRCK,                 BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//LCM_SCOURCE_AVEEEN
...
{REG_PIN_MEMS_MIC_CLK1,                 BITS_PIN_AF(0)},
{REG_MISC_PIN_MEMS_MIC_CLK1,            BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//PDM_CLK1
{REG_PIN_MEMS_MIC_DATA1,                BITS_PIN_AF(0)},
{REG_MISC_PIN_MEMS_MIC_DATA1,           BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//PDM_DATA1
