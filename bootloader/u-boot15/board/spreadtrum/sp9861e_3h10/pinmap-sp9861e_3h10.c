...
/*
 *Version SP9861-1_E-IA_V1.0.0_Pinmap  The version of pinlist was modified
 */
...
{REG_PIN_RFCTL33,                 BITS_AF(0)},
{REG_PIN_RFCTL33_MISC,            BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//NC
...
{REG_PIN_RFCTL37,                 BITS_AF(0)},
{REG_PIN_RFCTL37_MISC,            BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//NC
...
{REG_PIN_USB30_CC_SWITCH_MISC,    BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//NC
...
{REG_PIN_IIS1DI_MISC,             BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_IE},//WB_TX_REQ
{REG_PIN_IIS1DO,                  BITS_AF(3)},
{REG_PIN_IIS1DO_MISC,             BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_IE},//WB_RX_REQ   Marlin2 REQ TO BB  HIGH ACTIVE
{REG_PIN_IIS1CLK,                 BITS_AF(3)},
{REG_PIN_IIS1CLK_MISC,            BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//MAG_RST_N(NC)
...
{REG_PIN_U0RXD_MISC,              BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//NC
...
{REG_PIN_BEIDOU_COEXIST_MISC,     BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//NC
...
{REG_PIN_RFCTL2_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_POC|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL_2
{REG_PIN_RFCTL3,                  BITS_AF(0)},
{REG_PIN_RFCTL3_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL_3
{REG_PIN_RFCTL4,                  BITS_AF(0)},
{REG_PIN_RFCTL4_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL_4
{REG_PIN_RFCTL5,                  BITS_AF(0)},
{REG_PIN_RFCTL5_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL_5
{REG_PIN_RFCTL6,                  BITS_AF(0)},
{REG_PIN_RFCTL6_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL_6
...
{REG_PIN_KEYOUT1_MISC,            BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_IE},//LCD_ID
...
{REG_PIN_KEYIN1_MISC,             BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_IE},//HALL_INT
{REG_PIN_KEYIN2,                  BITS_PIN_AF(3)},
{REG_PIN_KEYIN2_MISC,             BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//SIM0_DET(NC)
//G3
...
{REG_PIN_SIMRST2_MISC,            BIT_PIN_SLP_AGCP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPD|BIT_PIN_SLP_WPD|BIT_PIN_SLP_OE},//FG_EN
...
{REG_PIN_EMMC_RSTB_MISC,          BIT_PIN_SLP_NONE|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//EMMC_RST
