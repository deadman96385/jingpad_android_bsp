...
/*
 *Version SC9861-2_IRD_E-IA_URSA_V1.0.0_Pinmap  The version of pinlist was modified
 */
...
{REG_PIN_CTRL1,0x0},
{REG_PIN_CTRL2,0x04408200}, //   uart1->ap'uart1; uart2->cp'uart0; uart3->gps; uart4->tgdsp'uart0
...
{REG_PIN_RFCTL33_MISC,            BITS_DEF(0x75)|BIT_SLP_NONE|BITS_STR(1)|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//Ursa_IRQ
...
{REG_PIN_SPI0_CSN_MISC,           BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//FTID_SPI_CS
...
{REG_PIN_EXTINT12_MISC,           BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPD|BIT_SLP_Z},//CHG_INT
...
{REG_PIN_RFCTL26,                 BITS_AF(2)},
{REG_PIN_RFCTL26_MISC,            BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//CAM_MCLK2
//G10
...
{REG_PIN_RFCTL29,                 BITS_AF(3)},
{REG_PIN_RFCTL29_MISC,            BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//CAM_PWDN2
{REG_PIN_RFCTL28,                 BITS_AF(3)},
{REG_PIN_RFCTL28_MISC,            BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//CAM_RST2
...
{REG_PIN_RFCTL0_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL0
{REG_PIN_RFCTL1,                  BITS_AF(0)},
{REG_PIN_RFCTL1_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL1
//G11
{REG_PIN_RFCTL2,                  BITS_AF(0)},
{REG_PIN_RFCTL2_MISC,             BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_POC|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL2
