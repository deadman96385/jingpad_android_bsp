...
/*
 *Version SC9850_2_IRD_J_V1.1.1_PINMAP_V1.0
 */
...
{REG_MISC_PIN_SCL3,                BIT_PIN_WPUS|BITS_PIN_DS(3)|BIT_PIN_WPU|BIT_PIN_SLP_NUL},//CTP_SCL
{REG_PIN_SDA3,                     BIT_PIN_SLP_AP|BITS_PIN_AF(0)|BIT_PIN_SLP_Z},
{REG_MISC_PIN_SDA3,                BIT_PIN_WPUS|BITS_PIN_DS(3)|BIT_PIN_WPU|BIT_PIN_SLP_NUL},//CTP_SDA
...
{REG_MISC_PIN_MEMS_MIC_CLK0,       BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//WF_COEXIST      GPIO94
{REG_PIN_MEMS_MIC_DATA0,           BIT_PIN_SLP_AP|BITS_PIN_AF(3)|BIT_PIN_SLP_IE},
{REG_MISC_PIN_MEMS_MIC_DATA0,      BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//AG_INT1         GPIO95
{REG_PIN_MEMS_MIC_CLK1,            BIT_PIN_SLP_AP|BITS_PIN_AF(3)|BIT_PIN_SLP_Z},
{REG_MISC_PIN_MEMS_MIC_CLK1,       BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//NC              GPIO96
{REG_PIN_MEMS_MIC_DATA1,           BIT_PIN_SLP_AP|BITS_PIN_AF(3)|BIT_PIN_SLP_OE},
{REG_MISC_PIN_MEMS_MIC_DATA1,      BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL},//WB_CHIP_EN      GPIO97
...
{REG_MISC_PIN_IIS0CLK,             BIT_PIN_NULL|BITS_PIN_DS(0)|BIT_PIN_NUL|BIT_PIN_SLP_NUL},//BT_PCM_CLK
{REG_PIN_IIS0LRCK,                 BIT_PIN_SLP_ALL|BITS_PIN_AF(0)|BIT_PIN_SLP_IE},
{REG_MISC_PIN_IIS0LRCK,            BIT_PIN_NULL|BITS_PIN_DS(0)|BIT_PIN_NUL|BIT_PIN_SLP_NUL},//BT_PCM_SYNC
