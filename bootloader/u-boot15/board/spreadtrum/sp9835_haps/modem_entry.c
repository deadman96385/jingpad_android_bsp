...
#define DSP_BOOT_IRAM_START   0x20000//2k
#define LDSP_SHARE_MEM_START  0x20800//10k
#define TGDSP_SHARE_MEM_START 0x23000//4k
#define MULTI_MODE_MEM_START  0x24000//4k
