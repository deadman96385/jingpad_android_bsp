...
#define CONFIG_LCD_FT8006P_HLT_MIPI_HDP
#define CONFIG_LCD_FT8006P_HUAXIAN_MIPI_HDP
#define CONFIG_LCM_GPIO_AVDDEN  114
#define CONFIG_LCM_GPIO_AVEEEN  112
#define CONFIG_LCM_GPIO_RSTN    50
#define CONFIG_LCM_GPIO_BL_EN    133
