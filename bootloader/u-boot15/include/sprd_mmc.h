...
#define OCR_VOLTAGE_MASK	0x40000080
...
ulong emmc_write_backstage(char part_num, uint32_t start_block, uint32_t num, uint8_t *buf);
...
int mmc_read(struct mmc *mmc, u64 src, uint8_t *dst, int size);
