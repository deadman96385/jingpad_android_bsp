...
#define REG_AON_SEC_APB_RVBARADDR0_BIG     ( CTL_BASE_AON_SEC_APB + 0x002C )
#define REG_AON_SEC_APB_RVBARADDR1_BIG     ( CTL_BASE_AON_SEC_APB + 0x0030 )
#define REG_AON_SEC_APB_RVBARADDR2_BIG     ( CTL_BASE_AON_SEC_APB + 0x0034 )
#define REG_AON_SEC_APB_RVBARADDR3_BIG     ( CTL_BASE_AON_SEC_APB + 0x0038 )
