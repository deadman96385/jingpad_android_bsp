...
#define REG_MM_DVFS_AHB_MM_DFS_SW_TRIG_CFG                ( CTL_BASE_MM_DVFS_AHB + 0x000C )
...
#define REG_MM_DVFS_AHB_FD_INDEX0_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x0170 )
#define REG_MM_DVFS_AHB_FD_INDEX1_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x0174 )
#define REG_MM_DVFS_AHB_FD_INDEX2_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x0178 )
#define REG_MM_DVFS_AHB_FD_INDEX3_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x017C )
#define REG_MM_DVFS_AHB_FD_INDEX4_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x0180 )
#define REG_MM_DVFS_AHB_FD_INDEX5_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x0184 )
#define REG_MM_DVFS_AHB_FD_INDEX6_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x0188 )
#define REG_MM_DVFS_AHB_FD_INDEX7_MAP                     ( CTL_BASE_MM_DVFS_AHB + 0x018C )
#define REG_MM_DVFS_AHB_ISP_DVFS_INDEX_CFG                ( CTL_BASE_MM_DVFS_AHB + 0x01C0 )
#define REG_MM_DVFS_AHB_ISP_DVFS_INDEX_IDLE_CFG           ( CTL_BASE_MM_DVFS_AHB + 0x01C4 )
#define REG_MM_DVFS_AHB_JPG_DVFS_INDEX_CFG                ( CTL_BASE_MM_DVFS_AHB + 0x01C8 )
#define REG_MM_DVFS_AHB_JPG_DVFS_INDEX_IDLE_CFG           ( CTL_BASE_MM_DVFS_AHB + 0x01CC )
#define REG_MM_DVFS_AHB_CPP_DVFS_INDEX_CFG                ( CTL_BASE_MM_DVFS_AHB + 0x01D0 )
#define REG_MM_DVFS_AHB_CPP_DVFS_INDEX_IDLE_CFG           ( CTL_BASE_MM_DVFS_AHB + 0x01D4 )
#define REG_MM_DVFS_AHB_MM_MTX_DVFS_INDEX_CFG             ( CTL_BASE_MM_DVFS_AHB + 0x01D8 )
#define REG_MM_DVFS_AHB_MM_MTX_DVFS_INDEX_IDLE_CFG        ( CTL_BASE_MM_DVFS_AHB + 0x01DC )
#define REG_MM_DVFS_AHB_DCAM_IF_DVFS_INDEX_CFG            ( CTL_BASE_MM_DVFS_AHB + 0x01E0 )
#define REG_MM_DVFS_AHB_DCAM_IF_DVFS_INDEX_IDLE_CFG       ( CTL_BASE_MM_DVFS_AHB + 0x01E4 )
#define REG_MM_DVFS_AHB_DCAM_AXI_DVFS_INDEX_CFG           ( CTL_BASE_MM_DVFS_AHB + 0x01E8 )
#define REG_MM_DVFS_AHB_DCAM_AXI_DVFS_INDEX_IDLE_CFG      ( CTL_BASE_MM_DVFS_AHB + 0x01EC )
#define REG_MM_DVFS_AHB_FD_DVFS_INDEX_CFG                 ( CTL_BASE_MM_DVFS_AHB + 0x01F0 )
#define REG_MM_DVFS_AHB_FD_DVFS_INDEX_IDLE_CFG            ( CTL_BASE_MM_DVFS_AHB + 0x01F4 )
#define REG_MM_DVFS_AHB_FREQ_UPD_STATE                    ( CTL_BASE_MM_DVFS_AHB + 0x0210 )
#define REG_MM_DVFS_AHB_MM_GFREE_WAIT_DELAY_CFG0          ( CTL_BASE_MM_DVFS_AHB + 0x0214 )
#define REG_MM_DVFS_AHB_MM_GFREE_WAIT_DELAY_CFG1          ( CTL_BASE_MM_DVFS_AHB + 0x0218 )
#define REG_MM_DVFS_AHB_MM_GFREE_WAIT_DELAY_CFG2          ( CTL_BASE_MM_DVFS_AHB + 0x021C )
#define REG_MM_DVFS_AHB_MM_FREQ_UPD_TYPE_CFG              ( CTL_BASE_MM_DVFS_AHB + 0x0220 )
#define REG_MM_DVFS_AHB_MM_DFS_IDLE_DISABLE_CFG           ( CTL_BASE_MM_DVFS_AHB + 0x0224 )
#define REG_MM_DVFS_AHB_MM_DVFS_RESERVED_REG_CFG0         ( CTL_BASE_MM_DVFS_AHB + 0x0230 )
#define REG_MM_DVFS_AHB_MM_DVFS_RESERVED_REG_CFG1         ( CTL_BASE_MM_DVFS_AHB + 0x0234 )
#define REG_MM_DVFS_AHB_MM_DVFS_RESERVED_REG_CFG2         ( CTL_BASE_MM_DVFS_AHB + 0x0238 )
#define REG_MM_DVFS_AHB_MM_DVFS_RESERVED_REG_CFG3         ( CTL_BASE_MM_DVFS_AHB + 0x023C )
...
#define BIT_MM_DVFS_AHB_MM_CURRENT_VOLTAGE_SW(x)          (((x) & 0x7) << 1)
