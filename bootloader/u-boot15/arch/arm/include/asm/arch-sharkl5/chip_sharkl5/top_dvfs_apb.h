...
#define REG_TOP_DVFS_APB_TOP_DVFS_RESERVED_REG_CFG0                ( CTL_BASE_TOP_DVFS_APB + 0x0194 )
#define REG_TOP_DVFS_APB_TOP_DVFS_RESERVED_REG_CFG1                ( CTL_BASE_TOP_DVFS_APB + 0x0198 )
#define REG_TOP_DVFS_APB_TOP_DVFS_RESERVED_REG_CFG2                ( CTL_BASE_TOP_DVFS_APB + 0x019C )
#define REG_TOP_DVFS_APB_TOP_DVFS_RESERVED_REG_CFG3                ( CTL_BASE_TOP_DVFS_APB + 0x01A0 )
