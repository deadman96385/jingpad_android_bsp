...
#define REG_AON_APB_APB_SEC_EB                        ( CTL_BASE_AON_APB + 0x001C )
...
#define REG_AON_APB_AON_CFG0                          ( CTL_BASE_AON_APB + 0x0030 )
...
#define REG_AON_APB_CSI_4P2L_M_PHY_CTRL               ( CTL_BASE_AON_APB + 0x007C )
#define REG_AON_APB_CSI_4P2L_DBG_PHY_CTRL             ( CTL_BASE_AON_APB + 0x0080 )
#define REG_AON_APB_CSI_4P2L_PHY_CTRL                 ( CTL_BASE_AON_APB + 0x0084 )
...
#define REG_AON_APB_HARD_DFS_HANSHAKE                 ( CTL_BASE_AON_APB + 0x00AC )
#define REG_AON_APB_APB_EB2                           ( CTL_BASE_AON_APB + 0x00B0 )
#define REG_AON_APB_WCN_BUS_REMAP                     ( CTL_BASE_AON_APB + 0x00CC )
#define REG_AON_APB_ANALOG_TSEN_ADC_CONFIG0           ( CTL_BASE_AON_APB + 0x00D0 )
#define REG_AON_APB_ANALOG_TSEN_ADC_CONFIG1           ( CTL_BASE_AON_APB + 0x00D4 )
#define REG_AON_APB_WCN_CONFIG0                       ( CTL_BASE_AON_APB + 0x00D8 )
...
#define REG_AON_APB_ANALOG_TSEN_ADC_CONFIG2           ( CTL_BASE_AON_APB + 0x0100 )
...
#define REG_AON_APB_CPLL_CFG1                         ( CTL_BASE_AON_APB + 0x0150 )
#define REG_AON_APB_CPLL_CFG2                         ( CTL_BASE_AON_APB + 0x0154 )
#define REG_AON_APB_GPLL_CFG1                         ( CTL_BASE_AON_APB + 0x0158 )
#define REG_AON_APB_GPLL_CFG2                         ( CTL_BASE_AON_APB + 0x015C )
...
#define REG_AON_APB_CPLL_BIST_CTRL                    ( CTL_BASE_AON_APB + 0x0188 )
#define REG_AON_APB_TWPLL_BIST_CTRL                   ( CTL_BASE_AON_APB + 0x018C )
#define REG_AON_APB_GPLL_BIST_CTRL                    ( CTL_BASE_AON_APB + 0x0190 )
#define REG_AON_APB_DPLL_CTRL                         ( CTL_BASE_AON_APB + 0x0194 )
#define REG_AON_APB_SENSOR_CFG0                       ( CTL_BASE_AON_APB + 0x01A0 )
#define REG_AON_APB_ANALOG_IOS_CFG                    ( CTL_BASE_AON_APB + 0x01A4 )
#define REG_AON_APB_MPLL_CFG3                         ( CTL_BASE_AON_APB + 0x01B0 )
#define REG_AON_APB_DPLL_CFG3                         ( CTL_BASE_AON_APB + 0x01B4 )
#define REG_AON_APB_CPLL_CFG3                         ( CTL_BASE_AON_APB + 0x01B8 )
#define REG_AON_APB_TWPLL_CFG3                        ( CTL_BASE_AON_APB + 0x01BC )
#define REG_AON_APB_GPLL_CFG3                         ( CTL_BASE_AON_APB + 0x01C0 )
...
#define REG_AON_APB_CP_CONFIG0                        ( CTL_BASE_AON_APB + 0x0258 )
#define REG_AON_APB_CP_CONFIG1                        ( CTL_BASE_AON_APB + 0x025C )
#define REG_AON_APB_RF_CONFIG                         ( CTL_BASE_AON_APB + 0x0260 )
...
#define REG_AON_APB_AON_MTX_EMC_LP_CTRL               ( CTL_BASE_AON_APB + 0x03D4 )
#define REG_AON_APB_AON_MTX_MAIN_LP_CTRL              ( CTL_BASE_AON_APB + 0x03D8 )
#define REG_AON_APB_AON_MTX_SW0_LP_CTRL               ( CTL_BASE_AON_APB + 0x03DC )
#define REG_AON_APB_AON_MTX_SW1_LP_CTRL               ( CTL_BASE_AON_APB + 0x03E0 )
#define REG_AON_APB_AON_MTX__RF_LP_CTRL               ( CTL_BASE_AON_APB + 0x03E4 )
#define REG_AON_APB_AON_MTX_WCN_LP_CTRL               ( CTL_BASE_AON_APB + 0x03E8 )
#define REG_AON_APB_SUBSYS_LPC_FORCE_REQ              ( CTL_BASE_AON_APB + 0x03F8 )
#define REG_AON_APB_SUBSYS_LPC_FORCE_ACK              ( CTL_BASE_AON_APB + 0x03FC )
#define REG_AON_APB_DAP_DJTAG_CTRL                    ( CTL_BASE_AON_APB + 0x0430 )
#define REG_AON_APB_EFUSE_CONFIG0                     ( CTL_BASE_AON_APB + 0x0450 )
...
#define REG_AON_APB_TOP_LPC4                          ( CTL_BASE_AON_APB + 0x0514 )
#define REG_AON_APB_TOP_LPC5                          ( CTL_BASE_AON_APB + 0x0518 )
#define REG_AON_APB_DDR_SLEEP_CTRL0                   ( CTL_BASE_AON_APB + 0x0530 )
#define REG_AON_APB_DDR_SLEEP_CTRL1                   ( CTL_BASE_AON_APB + 0x0534 )
#define REG_AON_APB_DDR_SLEEP_CTRL2                   ( CTL_BASE_AON_APB + 0x0538 )
#define REG_AON_APB_DDR_SLEEP_CTRL3                   ( CTL_BASE_AON_APB + 0x053C )
#define REG_AON_APB_ADI_CONFIG0                       ( CTL_BASE_AON_APB + 0x0540 )
...
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM0      ( CTL_BASE_AON_APB + 0x3114 )
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM1      ( CTL_BASE_AON_APB + 0x3118 )
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM2      ( CTL_BASE_AON_APB + 0x311C )
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_AP_SIM0         ( CTL_BASE_AON_APB + 0x3120 )
#define REG_AON_APB_DEEP_SLEEP_SOFT                   ( CTL_BASE_AON_APB + 0x3124 )
