 ...
 * whole.
 *
 * updated at 2018-12-18 10:55:08
 *
 */
...
#define CTL_BASE_MM_AHB 0x62200000


#define REG_MM_AHB_AHB_EB                      ( CTL_BASE_MM_AHB + 0x0000 )
#define REG_MM_AHB_AHB_RST                     ( CTL_BASE_MM_AHB + 0x0004 )
#define REG_MM_AHB_GEN_CLK_CFG                 ( CTL_BASE_MM_AHB + 0x0008 )
#define REG_MM_AHB_MM_QOS                      ( CTL_BASE_MM_AHB + 0x000C )
#define REG_MM_AHB_MM_LP_DISABLE               ( CTL_BASE_MM_AHB + 0x0010 )
#define REG_MM_AHB_MM_LPC_CTRL_ISP             ( CTL_BASE_MM_AHB + 0x0014 )
#define REG_MM_AHB_MM_LPC_CTRL_JPG             ( CTL_BASE_MM_AHB + 0x0018 )
#define REG_MM_AHB_MM_LPC_CTRL_CPP             ( CTL_BASE_MM_AHB + 0x001C )
#define REG_MM_AHB_MM_LPC_CTRL_MM_MAIN_MTX_S0  ( CTL_BASE_MM_AHB + 0x0020 )
#define REG_MM_AHB_MM_LPC_CTRL_AXI2AHB_M0      ( CTL_BASE_MM_AHB + 0x0024 )
#define REG_MM_AHB_MM_LPC_CTRL_DCAM_ASYNC_BDG  ( CTL_BASE_MM_AHB + 0x0028 )
#define REG_MM_AHB_MM_LPC_CTRL_MTX_ASYNC_BDG   ( CTL_BASE_MM_AHB + 0x002C )
#define REG_MM_AHB_MIPI_CSI_SEL_CTRL           ( CTL_BASE_MM_AHB + 0x0030 )
#define REG_MM_AHB_MM_0P5_APPEND               ( CTL_BASE_MM_AHB + 0x0034 )
#define REG_MM_AHB_MM_IP_BUSY                  ( CTL_BASE_MM_AHB + 0x0038 )
#define REG_MM_AHB_MM_AS_BDG_STATE             ( CTL_BASE_MM_AHB + 0x003C )
#define REG_MM_AHB_MM_LPC_CTRL_FD              ( CTL_BASE_MM_AHB + 0x0040 )
#define REG_MM_AHB_MM_LPC_PNUM_0               ( CTL_BASE_MM_AHB + 0x0044 )
#define REG_MM_AHB_MM_LPC_PNUM_1               ( CTL_BASE_MM_AHB + 0x0048 )
...
#define BIT_MM_AHB_ZZHDR_SOFT_RST                 BIT(25)
...
#define BIT_MM_AHB_MIPI_CSI_DPHY_C2_SEL1(x)       (((x) & 0x3) << 28)
...
/* REG_MM_AHB_MM_LPC_PNUM_0 */

#define BIT_MM_AHB_PU_NUM_ISP(x)                  (((x) & 0xFF) << 24)
#define BIT_MM_AHB_PU_NUM_JPG(x)                  (((x) & 0xFF) << 16)
#define BIT_MM_AHB_PU_NUM_CPP(x)                  (((x) & 0xFF) << 8)
#define BIT_MM_AHB_PU_NUM_MTX_S0(x)               (((x) & 0xFF))

/* REG_MM_AHB_MM_LPC_PNUM_1 */

#define BIT_MM_AHB_PU_NUM_AXI2AHB_M0(x)           (((x) & 0xFF) << 24)
#define BIT_MM_AHB_PU_NUM_DCAM_AS(x)              (((x) & 0xFF) << 16)
#define BIT_MM_AHB_PU_NUM_MTX_AS(x)               (((x) & 0xFF) << 8)
#define BIT_MM_AHB_PU_NUM_FD(x)                   (((x) & 0xFF))
