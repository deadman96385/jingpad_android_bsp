...
#define BIT_AON_DBG_APB_IPA_DBGEN              BIT(14)
#define BIT_AON_DBG_APB_PCIEPHY_DBGEN          BIT(13)
...
#define BIT_AON_DBG_APB_IPA_DBGEN_NON_SEC      BIT(14)
#define BIT_AON_DBG_APB_PCIEPHY_DBGEN_NON_SEC  BIT(13)
