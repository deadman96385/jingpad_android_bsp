...
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_DVFS(x)        (((x) & 0x3) << 8)
...
#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX0(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX0(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX0(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX1_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX1(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX1(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX1(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX2_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX2(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX2(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX2(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX3_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX3(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX3(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX3(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX4_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX4(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX4(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX4(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX5_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX5(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX5(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX5(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX6_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX6(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX6(x)      (((x) & 0x3) << 3)
#define BIT_AP_DVFS_APB_CGM_VDSP_SEL_INDEX6(x)        (((x) & 0x7))

/* REG_AP_DVFS_APB_VDSP_INDEX7_MAP */

#define BIT_AP_DVFS_APB_VDSP_VOL_INDEX7(x)            (((x) & 0x7) << 5)
#define BIT_AP_DVFS_APB_CGM_VDSP_M_DIV_INDEX7(x)      (((x) & 0x3) << 3)
