...
#define CTL_BASE_CM4_AHB 0x44020000


#define REG_CM4_AHB_CM4_EB                    ( CTL_BASE_CM4_AHB + 0x0000 )
#define REG_CM4_AHB_CM4_SOFT_RST              ( CTL_BASE_CM4_AHB + 0x0004 )
#define REG_CM4_AHB_AHB_PAUSE                 ( CTL_BASE_CM4_AHB + 0x0008 )
#define REG_CM4_AHB_CM4_SLP_CTL               ( CTL_BASE_CM4_AHB + 0x000C )
#define REG_CM4_AHB_CM4_CLK_EMC_CTRL          ( CTL_BASE_CM4_AHB + 0x0010 )
#define REG_CM4_AHB_CM4_CORE_SYSTICK_CFG      ( CTL_BASE_CM4_AHB + 0x0014 )
#define REG_CM4_AHB_CM4_CORE_AUXFAULT_CFG     ( CTL_BASE_CM4_AHB + 0x0018 )
#define REG_CM4_AHB_CM4_CORE_CFG1             ( CTL_BASE_CM4_AHB + 0x001C )
#define REG_CM4_AHB_FPU_CFG                   ( CTL_BASE_CM4_AHB + 0x0020 )
#define REG_CM4_AHB_CM4_MAIN_STATOUT          ( CTL_BASE_CM4_AHB + 0x0024 )
#define REG_CM4_AHB_CM4_INT_STAT              ( CTL_BASE_CM4_AHB + 0x0028 )
#define REG_CM4_AHB_AHB_MTX_CTL0              ( CTL_BASE_CM4_AHB + 0x002C )
#define REG_CM4_AHB_AHB_MTX_CTL1              ( CTL_BASE_CM4_AHB + 0x0030 )
#define REG_CM4_AHB_DMC_CTRL0                 ( CTL_BASE_CM4_AHB + 0x0034 )
#define REG_CM4_AHB_RTC_PERI_EB               ( CTL_BASE_CM4_AHB + 0x0038 )
#define REG_CM4_AHB_CM4_ARCH_SOFT_RST         ( CTL_BASE_CM4_AHB + 0x003C )
...
#define BIT_CM4_AHB_CLK_DMC_1X_SP_DIV(x)        (((x) & 0x3) << 13)
#define BIT_CM4_AHB_CLK_DMC_CLK_MODE_SP         BIT(12)
#define BIT_CM4_AHB_CLK_DMC_D2_SP_DIV(x)        (((x) & 0x3) << 10)
