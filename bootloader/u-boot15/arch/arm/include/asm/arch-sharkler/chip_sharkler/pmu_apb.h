...
#define REG_PMU_APB_PD_CA53_C0_CFG                             ( CTL_BASE_PMU_APB + 0x0004 )
#define REG_PMU_APB_PD_CA53_C1_CFG                             ( CTL_BASE_PMU_APB + 0x0008 )
#define REG_PMU_APB_PD_CA53_C2_CFG                             ( CTL_BASE_PMU_APB + 0x000C )
#define REG_PMU_APB_PD_CA53_C3_CFG                             ( CTL_BASE_PMU_APB + 0x0010 )
#define REG_PMU_APB_PD_CA53_TOP_CFG2                           ( CTL_BASE_PMU_APB + 0x0014 )
...
#define REG_PMU_APB_ISPPLL_REL_CFG                             ( CTL_BASE_PMU_APB + 0x0088 )
...
#define REG_PMU_APB_CA53_TOP_CFG                               ( CTL_BASE_PMU_APB + 0x00E4 )
#define REG_PMU_APB_CA53_C0_CFG                                ( CTL_BASE_PMU_APB + 0x00E8 )
#define REG_PMU_APB_CA53_C1_CFG                                ( CTL_BASE_PMU_APB + 0x00EC )
#define REG_PMU_APB_CA53_C2_CFG                                ( CTL_BASE_PMU_APB + 0x00F0 )
#define REG_PMU_APB_CA53_C3_CFG                                ( CTL_BASE_PMU_APB + 0x00F4 )
...
#define REG_PMU_APB_CA53_CORE_WAKEUP_EN                        ( CTL_BASE_PMU_APB + 0x0174 )
...
#define REG_PMU_APB_WCN_SYS_CORE_INT_DISABLE                   ( CTL_BASE_PMU_APB + 0x01A4 )
#define REG_PMU_APB_GNSS_WRAP_CORE_INT_DISABLE                 ( CTL_BASE_PMU_APB + 0x01A8 )
...
#define REG_PMU_APB_CA53_C0_CORE_INT_DISABLE                   ( CTL_BASE_PMU_APB + 0x01BC )
#define REG_PMU_APB_CA53_C1_CORE_INT_DISABLE                   ( CTL_BASE_PMU_APB + 0x01C0 )
#define REG_PMU_APB_CA53_C2_CORE_INT_DISABLE                   ( CTL_BASE_PMU_APB + 0x01C4 )
#define REG_PMU_APB_CA53_C3_CORE_INT_DISABLE                   ( CTL_BASE_PMU_APB + 0x01C8 )
...
#define REG_PMU_APB_CA53_C0_DSLP_ENA                           ( CTL_BASE_PMU_APB + 0x0348 )
#define REG_PMU_APB_CA53_C1_DSLP_ENA                           ( CTL_BASE_PMU_APB + 0x034C )
#define REG_PMU_APB_CA53_C2_DSLP_ENA                           ( CTL_BASE_PMU_APB + 0x0350 )
#define REG_PMU_APB_CA53_C3_DSLP_ENA                           ( CTL_BASE_PMU_APB + 0x0354 )
#define REG_PMU_APB_CA53_GIC_RST_EN                            ( CTL_BASE_PMU_APB + 0x0358 )
...
#define REG_PMU_APB_PD_CA53_C0_SHUTDOWN_MARK_STATUS            ( CTL_BASE_PMU_APB + 0x3000 )
#define REG_PMU_APB_PD_CA53_C1_SHUTDOWN_MARK_STATUS            ( CTL_BASE_PMU_APB + 0x3004 )
#define REG_PMU_APB_PD_CA53_C2_SHUTDOWN_MARK_STATUS            ( CTL_BASE_PMU_APB + 0x3008 )
#define REG_PMU_APB_PD_CA53_C3_SHUTDOWN_MARK_STATUS            ( CTL_BASE_PMU_APB + 0x300C )
...
#define REG_PMU_APB_PD_WCN_SYS_SHUTDOWN_MARK_STATUS            ( CTL_BASE_PMU_APB + 0x3058 )
#define REG_PMU_APB_PD_WIFI_WRAP_SHUTDOWN_MARK_STATUS          ( CTL_BASE_PMU_APB + 0x305C )
#define REG_PMU_APB_PD_GNSS_WRAP_SHUTDOWN_MARK_STATUS          ( CTL_BASE_PMU_APB + 0x3060 )
#define REG_PMU_APB_AP_SYS_SLEEP_CNT                           ( CTL_BASE_PMU_APB + 0x3064 )
#define REG_PMU_APB_WTLCP_SYS_SLEEP_CNT                        ( CTL_BASE_PMU_APB + 0x3068 )
#define REG_PMU_APB_PUBCP_SYS_SLEEP_CNT                        ( CTL_BASE_PMU_APB + 0x306C )
#define REG_PMU_APB_WCN_SYS_SLEEP_CNT                          ( CTL_BASE_PMU_APB + 0x3070 )
#define REG_PMU_APB_PUB_SYS_LIGHT_SLEEP_CNT                    ( CTL_BASE_PMU_APB + 0x3074 )
#define REG_PMU_APB_AP_DEEP_SLEEP_CNT                          ( CTL_BASE_PMU_APB + 0x3078 )
#define REG_PMU_APB_SP_SYS_DEEP_SLEEP_CNT                      ( CTL_BASE_PMU_APB + 0x307C )
#define REG_PMU_APB_WTLCP_DEEP_SLEEP_CNT                       ( CTL_BASE_PMU_APB + 0x3080 )
#define REG_PMU_APB_PUBCP_DEEP_SLEEP_CNT                       ( CTL_BASE_PMU_APB + 0x3084 )
#define REG_PMU_APB_WCN_SYS_DEEP_SLEEP_CNT                     ( CTL_BASE_PMU_APB + 0x3088 )
#define REG_PMU_APB_PUB_SYS_DEEP_SLEEP_CNT                     ( CTL_BASE_PMU_APB + 0x308C )
#define REG_PMU_APB_AP_LIGHT_SLEEP_CNT                         ( CTL_BASE_PMU_APB + 0x3090 )
#define REG_PMU_APB_WTLCP_LIGHT_SLEEP_CNT                      ( CTL_BASE_PMU_APB + 0x3094 )
#define REG_PMU_APB_PUBCP_LIGHT_SLEEP_CNT                      ( CTL_BASE_PMU_APB + 0x3098 )
#define REG_PMU_APB_WCN_SYS_LIGHT_SLEEP_CNT                    ( CTL_BASE_PMU_APB + 0x309C )
#define REG_PMU_APB_AON_SYS_LIGHT_SLEEP_CNT                    ( CTL_BASE_PMU_APB + 0x30A0 )
#define REG_PMU_APB_SYS_SOFT_RST_BUSY                          ( CTL_BASE_PMU_APB + 0x30A4 )
#define REG_PMU_APB_REG_SYS_SRST_FRC_LP_ACK                    ( CTL_BASE_PMU_APB + 0x30A8 )
#define REG_PMU_APB_SOFT_RST_SEL                               ( CTL_BASE_PMU_APB + 0x30AC )
#define REG_PMU_APB_REG_SYS_DDR_PWR_HS_ACK                     ( CTL_BASE_PMU_APB + 0x30B0 )
#define REG_PMU_APB_CSI_DSI_PWR_CNT_DONE                       ( CTL_BASE_PMU_APB + 0x30B4 )
#define REG_PMU_APB_PD_AP_SYS_DBG_SHUTDOWN__EN                 ( CTL_BASE_PMU_APB + 0x30B8 )
#define REG_PMU_APB_WCN_SYS_SLEEP_XTL_ON_SEL                   ( CTL_BASE_PMU_APB + 0x30BC )
#define REG_PMU_APB_EIC_SYS_SEL                                ( CTL_BASE_PMU_APB + 0x30C0 )
#define REG_PMU_APB_DDR_SLP_CTRL_STATE                         ( CTL_BASE_PMU_APB + 0x30C4 )
#define REG_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_LOW               ( CTL_BASE_PMU_APB + 0x30C8 )
#define REG_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_HIGH              ( CTL_BASE_PMU_APB + 0x30CC )
#define REG_PMU_APB_RCO_CTRL0                                  ( CTL_BASE_PMU_APB + 0x30D0 )
#define REG_PMU_APB_RCO_CTRL1                                  ( CTL_BASE_PMU_APB + 0x30D4 )
#define REG_PMU_APB_RCO_WAIT_CNT                               ( CTL_BASE_PMU_APB + 0x30D8 )
...
#define BIT_PMU_APB_PD_TD_PROC_FORCE_DEEP_SLEEP                  BIT(0)
...
#define BIT_PMU_APB_CGM_FORCE_EN_CFG0(x)                         (((x) & 0x1FFFFFF) << 7)
#define BIT_PMU_APB_PD_WTLCP_TD_ACK_M                            BIT(6)
#define BIT_PMU_APB_PD_WTLCP_TD_ACK_D                            BIT(5)
#define BIT_PMU_APB_PD_WTLCP_TD_STATE(x)                         (((x) & 0x1F))
...
#define BIT_PMU_APB_AON_SYS_SMART_LSLP_ENA                       BIT(27)
#define BIT_PMU_APB_WCN_SYS_SMART_LSLP_ENA                       BIT(26)
#define BIT_PMU_APB_WTLCP_SMART_LSLP_ENA                         BIT(25)
#define BIT_PMU_APB_PUBCP_SMART_LSLP_ENA                         BIT(24)
#define BIT_PMU_APB_GPU_SMART_LSLP_ENA                           BIT(23)
#define BIT_PMU_APB_MM_SMART_LSLP_ENA                            BIT(22)
#define BIT_PMU_APB_AP_SMART_LSLP_ENA                            BIT(21)
...
#define BIT_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_EN                  BIT(28)
#define BIT_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_CLR                 BIT(20)
...
#define BIT_PMU_APB_CA53_TOP_DEEP_SLEEP_CNT_CLR                  BIT(1)
...
#define BIT_PMU_APB_DCXO_LC_DEEP_SLEEP_RCO_DEEP_SLEEP_MASK       BIT(30)
#define BIT_PMU_APB_PAD_OUT_XTL_BUF_EN1_RCO_DEEP_SLEEP_MASK      BIT(29)
#define BIT_PMU_APB_PAD_OUT_XTL_BUF_EN0_RCO_DEEP_SLEEP_MASK      BIT(28)
#define BIT_PMU_APB_PAD_OUT_XTL_EN_RCO_DEEP_SLEEP_MASK           BIT(27)
#define BIT_PMU_APB_PAD_OUT_CHIP_SLEEP_RCO_DEEP_SLEEP_MASK       BIT(26)
...
/* REG_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_LOW */

#define BIT_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_LOW(x)              (((x) & 0xFFFFFFFF))

/* REG_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_HIGH */

#define BIT_PMU_APB_CHIP_DEEP_SLEEP_TIME_CNT_HIGH(x)             (((x) & 0xFFFFFFFF))

/* REG_PMU_APB_RCO_CTRL0 */

#define BIT_PMU_APB_SWITCH_PLL_WAIT_DLY(x)                       (((x) & 0xFF) << 24)
#define BIT_PMU_APB_WAKEUP_DLY(x)                                (((x) & 0xFF) << 16)
#define BIT_PMU_APB_SWITCH_RCO_WAIT_DLY(x)                       (((x) & 0xFF) << 8)
#define BIT_PMU_APB_RCO_ON_DLY(x)                                (((x) & 0xFF))

/* REG_PMU_APB_RCO_CTRL1 */

#define BIT_PMU_APB_ISPPLL_RCO_SEL                               BIT(10)
#define BIT_PMU_APB_RPLL_RCO_SEL                                 BIT(9)
#define BIT_PMU_APB_GPLL_RCO_SEL                                 BIT(8)
#define BIT_PMU_APB_LTEPLL_RCO_SEL                               BIT(7)
#define BIT_PMU_APB_TWPLL_RCO_SEL                                BIT(6)
#define BIT_PMU_APB_DPLL_RCO_SEL                                 BIT(5)
#define BIT_PMU_APB_MPLL_RCO_SEL                                 BIT(4)
#define BIT_PMU_APB_CHIP_FORCE_DEEP_SLEEP_RCO                    BIT(3)
#define BIT_PMU_APB_CHIP_DEEP_SLEEP_RCO_AUTO_ENABLE              BIT(2)
#define BIT_PMU_APB_CHIP_DEEP_SLEEP_RCO_SEL                      BIT(1)
#define BIT_PMU_APB_RCO_START                                    BIT(0)

/* REG_PMU_APB_RCO_WAIT_CNT */
