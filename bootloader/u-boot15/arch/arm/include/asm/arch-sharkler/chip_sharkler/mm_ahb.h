...
#define REG_MM_AHB_QOS_THREHOLD_MM      ( CTL_BASE_MM_AHB + 0x0010 )
#define REG_MM_AHB_MM_LP_DISABLE        ( CTL_BASE_MM_AHB + 0x0014 )
#define REG_MM_AHB_MM_LPC_CTRL_DCAM     ( CTL_BASE_MM_AHB + 0x0018 )
#define REG_MM_AHB_MM_LPC_CTRL_ISP      ( CTL_BASE_MM_AHB + 0x001C )
#define REG_MM_AHB_MM_LPC_CTRL_JPG      ( CTL_BASE_MM_AHB + 0x0020 )
#define REG_MM_AHB_MM_LPC_CTRL_CPP      ( CTL_BASE_MM_AHB + 0x0024 )
#define REG_MM_AHB_MM_LPC_CTRL_MTX_S0   ( CTL_BASE_MM_AHB + 0x0028 )

/* REG_MM_AHB_AHB_EB */

#define BIT_MM_AHB_DCAM_BPC_EB                 BIT(7)
...
#define BIT_MM_AHB_CCIR_SOFT_RST               BIT(16)
...
#define BIT_MM_AHB_CGM_CCIR_PCLK_EN            BIT(3)
