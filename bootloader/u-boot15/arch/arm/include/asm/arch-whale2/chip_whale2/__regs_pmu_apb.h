...
#define __H_REGS_PMU_APB_HEADFILE_H__
...
#define REG_PMU_APB_CLK26M_SEL_CFG                                 SCI_ADDR(REGS_PMU_APB_BASE, 0x0110 )
...
#define REG_PMU_APB_CPPLL_REL_CFG                                  SCI_ADDR(REGS_PMU_APB_BASE, 0x02B4 )
...
#define REG_PMU_APB_PD_WTLCP_LTE_HARQRAM_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0350 )
#define REG_PMU_APB_PD_AON_SYS_CFG                                 SCI_ADDR(REGS_PMU_APB_BASE, 0x0354 )
#define REG_PMU_APB_PLL_CHARGE_DLY                                 SCI_ADDR(REGS_PMU_APB_BASE, 0x0358 )
#define REG_PMU_APB_PD_GPU_C2_CFG                                  SCI_ADDR(REGS_PMU_APB_BASE, 0x035C )
#define REG_PMU_APB_PD_GPU_C3_CFG                                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0360 )
#define REG_PMU_APB_CA53_LIT_L2_DORMANT_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0364 )
#define REG_PMU_APB_MEM_AUTO_SLP_EN1                               SCI_ADDR(REGS_PMU_APB_BASE, 0x0368 )
#define REG_PMU_APB_MEM_AUTO_SD_EN1                                SCI_ADDR(REGS_PMU_APB_BASE, 0x036C )
#define REG_PMU_APB_MEM_SLP_CFG1                                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0370 )
#define REG_PMU_APB_MEM_SD_CFG1                                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0374 )
#define REG_PMU_APB_MEM_SLP_CFG2                                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0378 )
#define REG_PMU_APB_MEM_SD_CFG2                                    SCI_ADDR(REGS_PMU_APB_BASE, 0x037C )
#define REG_PMU_APB_MEM_SLP_CFG3                                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0380 )
#define REG_PMU_APB_MEM_SD_CFG3                                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0384 )
#define REG_PMU_APB_PUB_DSLP_CFG                                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0388 )
#define REG_PMU_APB_CP_PUB_PD_CFG                                  SCI_ADDR(REGS_PMU_APB_BASE, 0x038C )
#define REG_PMU_APB_BISR_WAIT_SRAM_CFG                             SCI_ADDR(REGS_PMU_APB_BASE, 0x0390 )
#define REG_PMU_APB_CA53_GIC_RST_EN                                SCI_ADDR(REGS_PMU_APB_BASE, 0x0394 )
#define REG_PMU_APB_NOC_SLP_CFG                                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0398 )
#define REG_PMU_APB_PMU_DEBUG                                      SCI_ADDR(REGS_PMU_APB_BASE, 0x039C )
#define REG_PMU_APB_PMU_DUMMY_REG                                  SCI_ADDR(REGS_PMU_APB_BASE, 0x03A0 )
...
#define REG_PMU_APB_PD_WTLCP_LTE_HARQRAM_SHUTDOWN_MARK_STATUS      SCI_ADDR(REGS_PMU_APB_BASE, 0x309C )
#define REG_PMU_APB_PD_GPU_C2_SHUTDOWN_MARK_STATUS                 SCI_ADDR(REGS_PMU_APB_BASE, 0x30A0 )
#define REG_PMU_APB_PD_GPU_C3_SHUTDOWN_MARK_STATUS                 SCI_ADDR(REGS_PMU_APB_BASE, 0x30A4 )
...
#define BIT_PMU_APB_MPLL1_FORCE_OFF                                        BIT(25)
#define BIT_PMU_APB_MPLL1_FORCE_ON                                         BIT(24)
...
#define BIT_PMU_APB_MPLL0_FORCE_OFF                                        BIT(9)
#define BIT_PMU_APB_MPLL0_FORCE_ON                                         BIT(8)
...
#define BIT_PMU_APB_DPLL1_FORCE_OFF                                        BIT(25)
#define BIT_PMU_APB_DPLL1_FORCE_ON                                         BIT(24)
...
#define BIT_PMU_APB_DPLL0_FORCE_OFF                                        BIT(9)
#define BIT_PMU_APB_DPLL0_FORCE_ON                                         BIT(8)
...
#define BIT_PMU_APB_LVDSDIS_PLL_FORCE_OFF                                  BIT(9)
#define BIT_PMU_APB_LVDSDIS_PLL_FORCE_ON                                   BIT(8)
...
#define BIT_PMU_APB_DDR0_CHN10_CGM_SEL                                     BIT(10)
...
#define BIT_PMU_APB_DDR1_CHN10_CGM_SEL                                     BIT(10)
...
#define BIT_PMU_APB_XTLBUF2_FORCE_OFF                                      BIT(9)
#define BIT_PMU_APB_XTLBUF2_FORCE_ON                                       BIT(8)
...
#define BIT_PMU_APB_LTEPLL1_FORCE_OFF                                      BIT(12)
#define BIT_PMU_APB_LTEPLL1_FORCE_ON                                       BIT(11)
...
#define BIT_PMU_APB_MEM_SLP_CFG0(x)                                        (((x) & 0xFFFFFFFF))
...
#define BIT_PMU_APB_MEM_SD_CFG0(x)                                         (((x) & 0xFFFFFFFF))
...
#define BIT_PMU_APB_PD_GPU_C3_BISR_DONE                                    BIT(13)
#define BIT_PMU_APB_PD_GPU_C2_BISR_DONE                                    BIT(12)
#define BIT_PMU_APB_PD_AON_SYS_BISR_DONE                                   BIT(11)
...
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_BISR_DONE                         BIT(6)
...
#define BIT_PMU_APB_PD_GPU_C3_BISR_BUSY                                    BIT(13)
#define BIT_PMU_APB_PD_GPU_C2_BISR_BUSY                                    BIT(12)
#define BIT_PMU_APB_PD_AON_SYS_BISR_BUSY                                   BIT(11)
...
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_BISR_BUSY                         BIT(6)
...
#define BIT_PMU_APB_PD_GPU_C3_BISR_FORCE_BYP                               BIT(13)
#define BIT_PMU_APB_PD_GPU_C2_BISR_FORCE_BYP                               BIT(12)
#define BIT_PMU_APB_PD_AON_SYS_BISR_FORCE_BYP                              BIT(11)
...
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_BISR_FORCE_BYP                    BIT(6)
...
#define BIT_PMU_APB_PD_GPU_C3_BISR_FORCE_EN                                BIT(13)
#define BIT_PMU_APB_PD_GPU_C2_BISR_FORCE_EN                                BIT(12)
#define BIT_PMU_APB_PD_AON_SYS_BISR_FORCE_EN                               BIT(11)
...
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_BISR_FORCE_EN                     BIT(6)
...
#define BIT_PMU_APB_RPLL1_FORCE_OFF                                        BIT(25)
#define BIT_PMU_APB_RPLL1_FORCE_ON                                         BIT(24)
...
#define BIT_PMU_APB_RPLL0_FORCE_OFF                                        BIT(9)
#define BIT_PMU_APB_RPLL0_FORCE_ON                                         BIT(8)
...
#define BIT_PMU_APB_RC1_FORCE_OFF                                          BIT(19)
#define BIT_PMU_APB_RC1_FORCE_ON                                           BIT(18)
#define BIT_PMU_APB_RC0_FORCE_OFF                                          BIT(17)
#define BIT_PMU_APB_RC0_FORCE_ON                                           BIT(16)
...
#define BIT_PMU_APB_SHUTDOWN_BYP_DMC                                       BIT(6)
...
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_STATE(x)                          (((x) & 0x1F) << 10)
...
#define BIT_PMU_APB_CPPLL_FORCE_OFF                                        BIT(10)
#define BIT_PMU_APB_CPPLL_FORCE_ON                                         BIT(9)
#define BIT_PMU_APB_CPPLL_RELOCK_EN                                        BIT(8)
#define BIT_PMU_APB_CPPLL_REF_SEL                                          BIT(7)
#define BIT_PMU_APB_CPPLL_CM3_SEL                                          BIT(6)
#define BIT_PMU_APB_CPPLL_AGCP_SEL                                         BIT(5)
#define BIT_PMU_APB_CPPLL_WTLCP_SEL                                        BIT(4)
#define BIT_PMU_APB_CPPLL_PUBCP_SEL                                        BIT(3)
#define BIT_PMU_APB_CPPLL_AP_SEL                                           BIT(2)
...
#define BIT_PMU_APB_CPPLL_CNT_DONE                                         BIT(17)
...
#define BIT_PMU_APB_PD_GPU_C3_ACK_D                                        BIT(12)
#define BIT_PMU_APB_PD_GPU_C2_ACK_D                                        BIT(11)
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_ACK_D                             BIT(10)
...
#define BIT_PMU_APB_PD_GPU_C3_ACK_M                                        BIT(12)
#define BIT_PMU_APB_PD_GPU_C2_ACK_M                                        BIT(11)
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_ACK_M                             BIT(10)
...
#define BIT_PMU_APB_PD_CA53_LIT_MP4_SRAM_DLY(x)                            (((x) & 0xFF) << 8)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_WTLCP_LTE_HARQRAM_CFG
// Register Offset : 0x0350
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_FORCE_SHUTDOWN                    BIT(25)
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_AUTO_SHUTDOWN_EN                  BIT(24)
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_PWR_ON_DLY(x)                     (((x) & 0xFF) << 16)
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_PWR_ON_SEQ_DLY(x)                 (((x) & 0xFF) << 8)
#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_ISO_ON_DLY(x)                     (((x) & 0xFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_AON_SYS_CFG
...
#define BIT_PMU_APB_RPLL1_DLY_SEL                                          BIT(29)
#define BIT_PMU_APB_RPLL0_DLY_SEL                                          BIT(28)
#define BIT_PMU_APB_GPLL_DLY_SEL                                           BIT(27)
#define BIT_PMU_APB_CPPLL_DLY_SEL                                          BIT(26)
#define BIT_PMU_APB_LVDSDIS_PLL_DLY_SEL                                    BIT(25)
#define BIT_PMU_APB_TWPLL_DLY_SEL                                          BIT(24)
#define BIT_PMU_APB_LTEPLL1_DLY_SEL                                        BIT(23)
#define BIT_PMU_APB_LTEPLL_DLY_SEL                                         BIT(22)
#define BIT_PMU_APB_MPLL1_DLY_SEL                                          BIT(21)
#define BIT_PMU_APB_MPLL0_DLY_SEL                                          BIT(20)
#define BIT_PMU_APB_DPLL1_DLY_SEL                                          BIT(19)
#define BIT_PMU_APB_DPLL0_DLY_SEL                                          BIT(18)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_GPU_C2_CFG
// Register Offset : 0x035C
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_GPU_C2_RST_N_MASK                                   BIT(26)
#define BIT_PMU_APB_PD_GPU_C2_FORCE_SHUTDOWN                               BIT(25)
#define BIT_PMU_APB_PD_GPU_C2_AUTO_SHUTDOWN_EN                             BIT(24)
#define BIT_PMU_APB_PD_GPU_C2_PWR_ON_DLY(x)                                (((x) & 0xFF) << 16)
#define BIT_PMU_APB_PD_GPU_C2_PWR_ON_SEQ_DLY(x)                            (((x) & 0xFF) << 8)
#define BIT_PMU_APB_PD_GPU_C2_ISO_ON_DLY(x)                                (((x) & 0xFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_GPU_C3_CFG
// Register Offset : 0x0360
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_GPU_C3_RST_N_MASK                                   BIT(26)
#define BIT_PMU_APB_PD_GPU_C3_FORCE_SHUTDOWN                               BIT(25)
#define BIT_PMU_APB_PD_GPU_C3_AUTO_SHUTDOWN_EN                             BIT(24)
#define BIT_PMU_APB_PD_GPU_C3_PWR_ON_DLY(x)                                (((x) & 0xFF) << 16)
#define BIT_PMU_APB_PD_GPU_C3_PWR_ON_SEQ_DLY(x)                            (((x) & 0xFF) << 8)
#define BIT_PMU_APB_PD_GPU_C3_ISO_ON_DLY(x)                                (((x) & 0xFF))
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_AUTO_SLP_EN1
// Register Offset : 0x0368
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_AUTO_SLP_EN1(x)                                    (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_AUTO_SD_EN1
// Register Offset : 0x036C
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_AUTO_SD_EN1(x)                                     (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_SLP_CFG1
// Register Offset : 0x0370
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_SLP_CFG1(x)                                        (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_SD_CFG1
// Register Offset : 0x0374
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_SD_CFG1(x)                                         (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_SLP_CFG2
// Register Offset : 0x0378
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_SLP_CFG2(x)                                        (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_SD_CFG2
// Register Offset : 0x037C
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_SD_CFG2(x)                                         (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_SLP_CFG3
// Register Offset : 0x0380
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_SLP_CFG3(x)                                        (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_MEM_SD_CFG3
// Register Offset : 0x0384
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_MEM_SD_CFG3(x)                                         (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PUB_DSLP_CFG
// Register Offset : 0x0388
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_AP_PUB_DSLP_EN7                                        BIT(31)
#define BIT_PMU_APB_AP_PUB_DSLP_EN6                                        BIT(30)
#define BIT_PMU_APB_AP_PUB_DSLP_EN5                                        BIT(29)
#define BIT_PMU_APB_AP_PUB_DSLP_EN4                                        BIT(28)
#define BIT_PMU_APB_AP_PUB_DSLP_EN3                                        BIT(27)
#define BIT_PMU_APB_AP_PUB_DSLP_EN2                                        BIT(26)
#define BIT_PMU_APB_AP_PUB_DSLP_EN1                                        BIT(25)
#define BIT_PMU_APB_AP_PUB_DSLP_EN0                                        BIT(24)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN7                                     BIT(23)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN6                                     BIT(22)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN5                                     BIT(21)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN4                                     BIT(20)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN3                                     BIT(19)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN2                                     BIT(18)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN1                                     BIT(17)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_EN0                                     BIT(16)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN7                                     BIT(15)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN6                                     BIT(14)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN5                                     BIT(13)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN4                                     BIT(12)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN3                                     BIT(11)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN2                                     BIT(10)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN1                                     BIT(9)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_EN0                                     BIT(8)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN7                                      BIT(7)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN6                                      BIT(6)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN5                                      BIT(5)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN4                                      BIT(4)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN3                                      BIT(3)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN2                                      BIT(2)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN1                                      BIT(1)
#define BIT_PMU_APB_AGCP_PUB_DSLP_EN0                                      BIT(0)

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_CP_PUB_PD_CFG
// Register Offset : 0x038C
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_CA53_BUS_GATE_EN1                                      BIT(25)
#define BIT_PMU_APB_AP_BUS_GATE_EN1                                        BIT(24)
#define BIT_PMU_APB_PUBCP_BUS_GATE_EN1                                     BIT(23)
#define BIT_PMU_APB_WTLCP_BUS_GATE_EN1                                     BIT(22)
#define BIT_PMU_APB_AGCP_BUS_GATE_EN1                                      BIT(21)
#define BIT_PMU_APB_PUBCP_BUS_GATE_EN0                                     BIT(20)
#define BIT_PMU_APB_WTLCP_BUS_GATE_EN0                                     BIT(19)
#define BIT_PMU_APB_AGCP_BUS_GATE_EN0                                      BIT(18)
#define BIT_PMU_APB_PUBCP_PUB_DSLP_SEL(x)                                  (((x) & 0x3) << 16)
#define BIT_PMU_APB_WTLCP_PUB_DSLP_SEL(x)                                  (((x) & 0x3) << 14)
#define BIT_PMU_APB_AGCP_PUB_DSLP_SEL(x)                                   (((x) & 0x3) << 12)
#define BIT_PMU_APB_PUBCP_PUB_PD_SEL(x)                                    (((x) & 0x3) << 10)
#define BIT_PMU_APB_WTLCP_PUB_PD_SEL(x)                                    (((x) & 0x3) << 8)
#define BIT_PMU_APB_AGCP_PUB_PD_SEL(x)                                     (((x) & 0x3) << 6)
#define BIT_PMU_APB_PUBCP_FORCE_BYP_PUB1                                   BIT(5)
#define BIT_PMU_APB_PUBCP_FORCE_BYP_PUB0                                   BIT(4)
#define BIT_PMU_APB_WTLCP_FORCE_BYP_PUB1                                   BIT(3)
#define BIT_PMU_APB_WTLCP_FORCE_BYP_PUB0                                   BIT(2)
#define BIT_PMU_APB_AGCP_FORCE_BYP_PUB1                                    BIT(1)
#define BIT_PMU_APB_AGCP_FORCE_BYP_PUB0                                    BIT(0)
...
#define BIT_PMU_APB_BISR_WAIT_SRAM_CR5_EN                                  BIT(4)
#define BIT_PMU_APB_BISR_WAIT_SRAM_TGDSP_EN                                BIT(3)
#define BIT_PMU_APB_BISR_WAIT_SRAM_LDSP_EN                                 BIT(2)
#define BIT_PMU_APB_BISR_WAIT_SRAM_AGDSP_EN                                BIT(1)
#define BIT_PMU_APB_BISR_WAIT_SRAM_CA53_LIT_MP4_EN                         BIT(0)
...
#define BIT_PMU_APB_CA53_BIG_MP4_GIC_RST_EN                                BIT(2)
#define BIT_PMU_APB_CA53_LIT_CORE_GIC_RST_EN                               BIT(1)
#define BIT_PMU_APB_CA53_LIT_MP4_GIC_RST_EN                                BIT(0)

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_NOC_SLP_CFG
// Register Offset : 0x0398
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PUB1_AUTO_GATE_WITH_PUB0_EN                            BIT(4)
#define BIT_PMU_APB_PUB1_DEEP_SLEEP_CLK_SEL(x)                             (((x) & 0x3) << 2)
#define BIT_PMU_APB_PUB1_DEEP_SLEEP_CLK_SEL_EN                             BIT(1)
#define BIT_PMU_APB_NOC_SLP_REQ_STOP_BUSY_CLK_EN                           BIT(0)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_WTLCP_LTE_HARQRAM_SHUTDOWN_MARK_STATUS
// Register Offset : 0x309C
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_WTLCP_LTE_HARQRAM_SHUTDOWN_MARK(x)                  (((x) & 0xF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_GPU_C2_SHUTDOWN_MARK_STATUS
// Register Offset : 0x30A0
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_GPU_C2_SHUTDOWN_MARK(x)                             (((x) & 0xF))

/*---------------------------------------------------------------------------
// Register Name   : REG_PMU_APB_PD_GPU_C3_SHUTDOWN_MARK_STATUS
// Register Offset : 0x30A4
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_PMU_APB_PD_GPU_C3_SHUTDOWN_MARK(x)                             (((x) & 0xF))
