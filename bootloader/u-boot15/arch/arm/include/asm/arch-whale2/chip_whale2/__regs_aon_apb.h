...
#define __H_REGS_AON_APB_HEADFILE_H__
...
#define REG_AON_APB_SUB_SYS_DBG_SIG0           SCI_ADDR(REGS_AON_APB_BASE, 0x009C )
#define REG_AON_APB_SUB_SYS_DBG_SIG1           SCI_ADDR(REGS_AON_APB_BASE, 0x00A0 )
#define REG_AON_APB_SUB_SYS_DBG_SIG2           SCI_ADDR(REGS_AON_APB_BASE, 0x00A4 )
#define REG_AON_APB_SUB_SYS_DBG_SIG3           SCI_ADDR(REGS_AON_APB_BASE, 0x00A8 )
#define REG_AON_APB_SUB_SYS_DBG_SIG4           SCI_ADDR(REGS_AON_APB_BASE, 0x00AC )
#define REG_AON_APB_SUB_SYS_DBG_SIG5           SCI_ADDR(REGS_AON_APB_BASE, 0x00B0 )
#define REG_AON_APB_SUB_SYS_DBG_SIG6           SCI_ADDR(REGS_AON_APB_BASE, 0x00B4 )
#define REG_AON_APB_SUB_SYS_DBG_SIG7           SCI_ADDR(REGS_AON_APB_BASE, 0x00B8 )
#define REG_AON_APB_DEBUG_SUBSYS_SEL           SCI_ADDR(REGS_AON_APB_BASE, 0x00BC )
#define REG_AON_APB_MDAR_SYS_HSDL_CFG          SCI_ADDR(REGS_AON_APB_BASE, 0x00C0 )
...
#define REG_AON_APB_PUB_CTRL                   SCI_ADDR(REGS_AON_APB_BASE, 0x01C0 )
...
#define REG_AON_APB_DBG_BUS_5_0_SEL            SCI_ADDR(REGS_AON_APB_BASE, 0x01E4 )
#define REG_AON_APB_DBG_BUS_11_6_SEL           SCI_ADDR(REGS_AON_APB_BASE, 0x01E8 )
#define REG_AON_APB_DBG_BUS_17_12_SEL          SCI_ADDR(REGS_AON_APB_BASE, 0x01EC )
#define REG_AON_APB_DBG_BUS_23_18_SEL          SCI_ADDR(REGS_AON_APB_BASE, 0x01F0 )
#define REG_AON_APB_DBG_BUS_29_24_SEL          SCI_ADDR(REGS_AON_APB_BASE, 0x01F4 )
#define REG_AON_APB_DBG_BUS_31_30_SEL          SCI_ADDR(REGS_AON_APB_BASE, 0x01F8 )
...
#define REG_AON_APB_AON_SDIO                   SCI_ADDR(REGS_AON_APB_BASE, 0x312C )
#define REG_AON_APB_PWM_3D_MUX                 SCI_ADDR(REGS_AON_APB_BASE, 0x3134 )
...
#define BIT_I2C_EB  											  BIT_AON_APB_I2C_EB
...
#define BIT_AON_APB_PUB0_REG_EB                                   BIT(24)
...
#define BIT_AON_APB_PUB1_REG_EB                                   BIT(15)
...
#define BIT_AON_APB_DBG_EMC_EB                                    BIT(23)
...
#define BITS_AON_APB_AGCP_REG_PROT_VAL(x)						  BIT_AON_APB_AGCP_REG_PROT_VAL(x)
...
#define BITS_AON_APB_REG_PROT_VAL(x)							  BIT_AON_APB_REG_PROT_VAL(x)
...
#define BIT_AON_APB_CLK_DMC1_SEL_PLUS                             BIT(22)
#define BIT_AON_APB_CLK_DMC1_2X_DIV(x)                            (((x) & 0xF) << 18)
#define BIT_AON_APB_CLK_DMC1_1X_DIV                               BIT(17)
#define BIT_AON_APB_CLK_DMC1_SEL                                  BIT(16)
#define BIT_AON_APB_EMC_DDR0_CKG_SEL_CURRENT(x)                   (((x) & 0x7F) << 8)
#define BIT_AON_APB_CLK_DMC0_SEL_HW_EN                            BIT(7)
#define BIT_AON_APB_CLK_DMC0_SEL_PLUS                             BIT(6)
#define BIT_AON_APB_CLK_DMC0_2X_DIV(x)                            (((x) & 0xF) << 2)
#define BIT_AON_APB_CLK_DMC0_1X_DIV                               BIT(1)
#define BIT_AON_APB_CLK_DMC0_SEL                                  BIT(0)
...
#define BIT_AON_APB_DISP_DBG_SIG_SEL(x)                           (((x) & 0xFF) << 24)
#define BIT_AON_APB_DISP_DBG_MOD_SEL(x)                           (((x) & 0xFF) << 16)
#define BIT_AON_APB_VSP_DBG_SIG_SEL(x)                            (((x) & 0xFF) << 8)
#define BIT_AON_APB_VSP_DBG_MOD_SEL(x)                            (((x) & 0xFF))
...
#define BIT_AON_APB_PUB1_DBG_SIG_SEL(x)                           (((x) & 0xFF) << 24)
#define BIT_AON_APB_PUB1_DBG_MOD_SEL(x)                           (((x) & 0xFF) << 16)
...
#define BIT_AON_APB_PUB0_DBG_SIG_SEL(x)                           (((x) & 0xFF) << 8)
#define BIT_AON_APB_PUB0_DBG_MOD_SEL(x)                           (((x) & 0xFF))
...
#define BIT_AON_APB_CAM_DBG_SIG_SEL(x)                            (((x) & 0xFF) << 24)
#define BIT_AON_APB_CAM_DBG_MOD_SEL(x)                            (((x) & 0xFF) << 16)
#define BIT_AON_APB_AGCP_DBG_SIG_SEL(x)                           (((x) & 0xFF) << 8)
#define BIT_AON_APB_AGCP_DBG_MOD_SEL(x)                           (((x) & 0xFF))

/*---------------------------------------------------------------------------
// Register Name   : REG_AON_APB_SUB_SYS_DBG_SIG6
...
/*---------------------------------------------------------------------------
// Register Name   : REG_AON_APB_SUB_SYS_DBG_SIG7
...
#define BIT_AON_APB_DMC_DDR1_1X_FORCE_EN                          BIT(14)
...
#define BITS_AON_APB_AGCP_DSP_BOOT_VECTOR(x)					  BIT_AON_APB_AGCP_DSP_BOOT_VECTOR(x)
...
#define BIT_AON_APB_TOP_FORCE_GPU_CORE3_ON                        BIT(5)
#define BIT_AON_APB_TOP_FORCE_GPU_CORE2_ON                        BIT(4)
#define BIT_AON_APB_TOP_FORCE_GPU_CORE1_ON                        BIT(3)
#define BIT_AON_APB_TOP_FORCE_GPU_CORE0_ON                        BIT(2)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_AON_APB_PUB_CTRL
// Register Offset : 0x01C0
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_AON_APB_EMC_CKG_SEL_DEFAULT_PUB1_EXTEND               BIT(1)
#define BIT_AON_APB_EMC_CKG_SEL_DEFAULT_PUB0_EXTEND               BIT(0)
...
#define BIT_AON_APB_AON_APB_IDLE_SEL(x)                           (((x) & 0x7) << 3)
...
#define BIT_AON_APB_CAM_M1_NIU_IDLE_DET_DISABLE                   BIT(5)
...
#define BIT_AON_APB_CAM_M0_NIU_IDLE_DET_DISABLE                   BIT(1)
...
#define BIT_AON_APB_CAM_M1_IDLE                                   BIT(9)
...
#define BIT_AON_APB_SP_EIC_PUB1_NOTLAT_INT_WAKE_EN                BIT(31)
#define BIT_AON_APB_SP_EIC_PUB1_LAT_INT_WAKE_EN                   BIT(30)
#define BIT_AON_APB_SP_AGCP_DMA_CHN2_GRP2_WAKE_EN                 BIT(29)
#define BIT_AON_APB_SP_AGCP_DMA_CHN1_GRP2_WAKE_EN                 BIT(28)
#define BIT_AON_APB_SP_AGCP_DMA_CHN2_GRP1_WAKE_EN                 BIT(27)
#define BIT_AON_APB_SP_AGCP_DMA_CHN1_GRP1_WAKE_EN                 BIT(26)
#define BIT_AON_APB_SP_EIC_GPIO_NOTLAT_INT_WAKE_EN                BIT(25)
#define BIT_AON_APB_SP_EIC_GPIO_LAT_INT_WAKE_EN                   BIT(24)
#define BIT_AON_APB_SP_DMA_AGCP_INT_WAKE_EN                       BIT(23)
#define BIT_AON_APB_SP_CM4_SPI_INT_WAKE_EN                        BIT(22)
#define BIT_AON_APB_SP_BUSMON_INT_WAKE_EN                         BIT(21)
#define BIT_AON_APB_SP_FPU_INT_WAKE_EN                            BIT(20)
