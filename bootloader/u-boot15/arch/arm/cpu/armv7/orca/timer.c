...
int timer_init(void)
{
	...
	CHIP_REG_OR(REG_AON_APB_APB_EB1,  BIT_AON_APB_AP_SYST_EB);
	CHIP_REG_OR(REG_AON_APB_APB_RTC_EB0,  BIT_AON_APB_AP_SYST_RTC_EB);

	CHIP_REG_OR(REG_AON_APB_APB_EB2,  BIT_AON_APB_AP_TMR0_EB |
				BIT_AON_APB_AP_TMR1_EB | BIT_AON_APB_AP_TMR2_EB);
	CHIP_REG_OR(REG_AON_APB_APB_RTC_EB0,  BIT_AON_APB_AP_TMR0_RTC_EB |
				BIT_AON_APB_AP_TMR1_RTC_EB | BIT_AON_APB_AP_TMR2_RTC_EB);

	/* AON SYS TMR and AON TMR enable */
	CHIP_REG_OR(REG_AON_APB_APB_EB1,  BIT_AON_APB_AON_SYST_EB);
	CHIP_REG_OR(REG_AON_APB_APB_RTC_EB0,  BIT_AON_APB_AON_SYST_RTC_EB);

	CHIP_REG_OR(REG_AON_APB_APB_EB1,  BIT_AON_APB_AON_TMR_EB);
	CHIP_REG_OR(REG_AON_APB_APB_RTC_EB0,  BIT_AON_APB_AON_TMR_RTC_EB);

	CHIP_REG_OR(REG_AON_APB_CGM_REG1,  BIT_AON_APB_CGM_TMR_EN);
