...
void pmu_commom_config(void)
{
	...
	CHIP_REG_SET(REG_PMU_APB_PLL_WAIT_CNT0,
		BIT_PMU_APB_MPLL2_WAIT_CNT(0xFF) |
		BIT_PMU_APB_MPLL1_WAIT_CNT(0xFF) |
		BIT_PMU_APB_MPLL0_WAIT_CNT(0xFF) |
		0
	);
	...
	CHIP_REG_SET(REG_PMU_APB_PWR_CNT_WAIT_CFG1,
		...
		BIT_PMU_APB_SP_SYS_PWR_WAIT_CNT(0x28) |
	...
	CHIP_REG_SET(REG_PMU_APB_PMU_CLK_DIV_CFG,
		BIT_PMU_APB_PWR_ST_CLK_DIV_CFG(0x04) |
	...
	CHIP_REG_SET(REG_PMU_APB_PD_APCPU_TOP_CFG3,
		...
		BIT_PMU_APB_PD_DCDC_CPU1_PWR_ON_DLY(0x0) |
	...
	CHIP_REG_SET(REG_PMU_APB_APCPU_MODE_ST_CFG,
		BIT_PMU_APB_APCPU_CORINTH_RAM_PWR_DLY(0x41) |
...
void dvfs_mpll0_index_table_init()
{
	/* 962MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX0,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX0(0x4A) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_POSTDIV_INDEX0 |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX0(4));

	/* 1144MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX1,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX1(0x2C) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX1(0));

	/* 1482MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX2,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX2(0x39) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX2(2));

	/* 1534MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX3,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX3(0x3B) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX3(2));

	/* 1716MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX4,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX4(0x42) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX4(3));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX5,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX5(0x46) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX5(4));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX6,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX6(0x46) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX6(4));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G17_ANALOG_MPLL0_ANANKE_BIG_DVFS_INDEX7,
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_N_INDEX7(0x46) |
		    BIT_ANLG_PHY_G17_ANALOG_MPLL0_MPLL0_ICP_INDEX7(4));
}

void dvfs_mpll1_index_table_init()
{
	/* 1482MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX0,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX0(0x39) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX0(2));

	/* 1534MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX1,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX1(0x3b) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX1(2));

	/* 1742MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX2,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX2(0x43) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX2(3));

	/* 1794MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX3,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX3(0x45) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX3(3));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX4,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX4(0x46) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX4(4));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX5,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX5(0x46) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX5(4));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX6,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX6(0x46) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX6(4));

	/* 1820MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G4_ANALOG_MPLL1_PROMETHEUS_DVFS_INDEX7,
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_N_INDEX7(0x46) |
		     BIT_ANLG_PHY_G4_ANALOG_MPLL1_MPLL1_ICP_INDEX7(4));
}

void dvfs_mpll2_index_table_init()
{
	/* 520MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX0,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX0(0x28) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_POSTDIV_INDEX0 |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX0(0));

	/* 650MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX1,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX1(0x32) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_POSTDIV_INDEX1 |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX1(1));

	/* 858MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX2,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX2(0x42) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_POSTDIV_INDEX2 |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX2(3));

	/* 962MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX3,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX3(0x4A) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_POSTDIV_INDEX3 |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX3(4));

	/* 1118MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX4,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX4(0x2B) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX4(0));

	/* 1248MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX5,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX5(0x30) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX5(1));

	/* 1248MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX6,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX6(0x30) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX6(1));

	/* 1248MHZ */
	CHIP_REG_SET(REG_ANLG_PHY_G9_ANALOG_MPLL2_ANANKE_BIG_DVFS_INDEX7,
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_N_INDEX7(0x30) |
		    BIT_ANLG_PHY_G9_ANALOG_MPLL2_MPLL2_ICP_INDEX7(1));
}
...
void apcpu_hw_dvfs_config(void)
{
	...
	/* Safe DVFS Pre-binning Table */
	dvfs_mpll0_index_table_init();

	dvfs_mpll1_index_table_init();

	dvfs_mpll2_index_table_init();

	/*set cluster0 default dvfs index 2 twpll*/
	CHIP_REG_SET(REG_APCPU_DVFS_APB_ANANKE_DVFS_INDEX_CFG,
		     BIT_APCPU_DVFS_APB_ANANKE_DVFS_INDEX(0x2));

	/*set cluster1 default dvfs index 1 ltepll*/
	CHIP_REG_SET(REG_APCPU_DVFS_APB_PROMETHEUS_DVFS_INDEX_CFG,
		     BIT_APCPU_DVFS_APB_PROMETHEUS_DVFS_INDEX(0x1));
}
...
void aon_lpc_config(void)
{
	...
	CHIP_REG_OR(REG_AON_APB_APCPU_DDR_AB_LPC_CTRL, BIT_AON_APB_APCPU_DDR_AB0_LP_EB|BIT_AON_APB_APCPU_DDR_AB1_LP_EB);
...
void ap_lpc_config(void)
{
	...
	CHIP_REG_OR(REG_AP_AHB_VDSP_LP_CTRL, BIT_AP_AHB_VDSP_M0_AUTO_GATE_EN |
		BIT_AP_AHB_VDSP_EDAP_AUTO_GATE_EN |
		BIT_AP_AHB_VDSP_AUTO_GATE_EN
	);
}
...
void pad_out_sel_config(void)
{
	CHIP_REG_SET(REG_PMU_APB_PAD_OUT_CHIP_SLEEP_CFG,
		...
		//BIT_PMU_APB_PAD_OUT_CHIP_SLEEP_ESE_DEEP_SLEEP_MASK |
	...
	CHIP_REG_SET(REG_PMU_APB_PAD_OUT_XTL_EN0_CFG,
		...
		BIT_PMU_APB_PAD_OUT_XTL_EN0_ESE_DEEP_SLEEP_MASK |
	...
	CHIP_REG_SET(REG_PMU_APB_PAD_OUT_XTL_EN1_CFG,
		...
		BIT_PMU_APB_PAD_OUT_XTL_EN1_ESE_DEEP_SLEEP_MASK |
	...
	CHIP_REG_SET(REG_PMU_APB_PAD_OUT_DCDC_ARM0_EN_CFG,
		BIT_PMU_APB_PAD_OUT_DCDC_ARM0_EN_IPA_DEEP_SLEEP_MASK |
		...
		BIT_PMU_APB_PAD_OUT_DCDC_ARM0_EN_ESE_DEEP_SLEEP_MASK |
	...
	CHIP_REG_SET(REG_PMU_APB_PAD_OUT_DCDC_ARM1_EN_CFG,
		BIT_PMU_APB_PAD_OUT_DCDC_ARM1_EN_IPA_DEEP_SLEEP_MASK |
		...
		BIT_PMU_APB_PAD_OUT_DCDC_ARM1_EN_ESE_DEEP_SLEEP_MASK |
	...
	CHIP_REG_SET(REG_PMU_APB_DCXO_LP_DEEP_SLEEP_CFG,
		//BIT_PMU_APB_DCXO_LC_DEEP_SLEEP_IPA_DEEP_SLEEP_MASK |
		...
		//BIT_PMU_APB_DCXO_LC_DEEP_SLEEP_ESE_DEEP_SLEEP_MASK |
