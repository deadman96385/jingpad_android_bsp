...
void irq_llsr(struct irq_regs *regs)
{
	...
	case 0x05:
		...
		dump_regs(regs);
		panic("BOUND Range Exceeded Panic\n");
		break;
	case 0x06:
		printf("Invalid Opcode (UnDefined Opcode)\n");
		dump_regs(regs);
		panic("UnDefined Opcode Panic\n");
		break;
	case 0x07:
		printf("Device Not Available (No Math Coprocessor)\n");
		dump_regs(regs);
		panic("Device Not Available Panic\n");
		break;
	case 0x08:
		printf("Double fault\n");
		dump_regs(regs);
	...
	case 0x09:
		...
		dump_regs(regs);
		panic("Co-processor segment overrun Panic\n");
		break;
	case 0x0a:
		printf("Invalid TSS\n");
		dump_regs(regs);
	...
	case 0x0b:
		...
		dump_regs(regs);
		panic("Segment Not Present Panic\n");
		break;
	case 0x0c:
		printf("Stack Segment Fault\n");
		dump_regs(regs);
		panic("Stack Segment Fault Panic\n");
		break;
	case 0x0d:
