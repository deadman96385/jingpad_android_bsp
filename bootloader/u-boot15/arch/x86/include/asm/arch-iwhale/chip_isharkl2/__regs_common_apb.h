...
#define REG_COMMON_APB_WTL_ACC_FIFO_CH0_1              ( CTL_BASE_COMMON_APB + 0x00AC )
#define REG_COMMON_APB_WTL_ACC_FIFO_CH0_2              ( CTL_BASE_COMMON_APB + 0x00B0 )
...
#define REG_COMMON_APB_WTL_DSP_FIFO_CH0_1              ( CTL_BASE_COMMON_APB + 0x00C0 )
#define REG_COMMON_APB_WTL_DSP_FIFO_CH0_2              ( CTL_BASE_COMMON_APB + 0x00C4 )
...
#define REG_COMMON_APB_AON_DMA_SYS_SEL                 ( CTL_BASE_COMMON_APB + 0x3108 )
...
#define REG_COMMON_APB_DSIPLL_LOCK_STATUS              ( CTL_BASE_COMMON_APB + 0x31D8 )
...
/*---------------------------------------------------------------------------
// Register Name   : REG_COMMON_APB_WTL_ACC_FIFO_CH0_1
// Register Offset : 0x00AC
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_COMMON_APB_WTL_ACC_FIFO_AF_LVL_AW_CH0(x)                         (((x) & 0xF) << 28)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AE_LVL_AW_CH0(x)                         (((x) & 0xF) << 24)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AF_LVL_W_CH0(x)                          (((x) & 0x1F) << 19)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AE_LVL_W_CH0(x)                          (((x) & 0x1F) << 14)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AF_LVL_B_CH0(x)                          (((x) & 0x1F) << 9)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AE_LVL_B_CH0(x)                          (((x) & 0x1F) << 4)

/*---------------------------------------------------------------------------
// Register Name   : REG_COMMON_APB_WTL_ACC_FIFO_CH0_2
// Register Offset : 0x00B0
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_COMMON_APB_WTL_ACC_FIFO_AF_LVL_R_CH0(x)                          (((x) & 0x1F) << 27)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AE_LVL_R_CH0(x)                          (((x) & 0x1F) << 22)
#define BIT_COMMON_APB_BADDTION_S_WTL_ACC_PUB0(x)                            (((x) & 0xF) << 12)
#define BIT_COMMON_APB_RADDTION_S_WTL_ACC_PUB0(x)                            (((x) & 0xF) << 8)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AF_LVL_AR_CH0(x)                         (((x) & 0xF) << 4)
#define BIT_COMMON_APB_WTL_ACC_FIFO_AE_LVL_AR_CH0(x)                         (((x) & 0xF))
...
/*---------------------------------------------------------------------------
// Register Name   : REG_COMMON_APB_WTL_DSP_FIFO_CH0_1
// Register Offset : 0x00C0
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_COMMON_APB_WTL_DSP_FIFO_AF_LVL_AW_CH0(x)                         (((x) & 0xF) << 28)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AE_LVL_AW_CH0(x)                         (((x) & 0xF) << 24)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AF_LVL_W_CH0(x)                          (((x) & 0x1F) << 19)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AE_LVL_W_CH0(x)                          (((x) & 0x1F) << 14)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AF_LVL_B_CH0(x)                          (((x) & 0x1F) << 9)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AE_LVL_B_CH0(x)                          (((x) & 0x1F) << 4)

/*---------------------------------------------------------------------------
// Register Name   : REG_COMMON_APB_WTL_DSP_FIFO_CH0_2
// Register Offset : 0x00C4
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_COMMON_APB_WTL_DSP_FIFO_AF_LVL_R_CH0(x)                          (((x) & 0x1F) << 27)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AE_LVL_R_CH0(x)                          (((x) & 0x1F) << 22)
#define BIT_COMMON_APB_BADDTION_S_WTL_DSP_PUB0(x)                            (((x) & 0xF) << 12)
#define BIT_COMMON_APB_RADDTION_S_WTL_DSP_PUB0(x)                            (((x) & 0xF) << 8)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AF_LVL_AR_CH0(x)                         (((x) & 0xF) << 4)
#define BIT_COMMON_APB_WTL_DSP_FIFO_AE_LVL_AR_CH0(x)                         (((x) & 0xF))
...
/*---------------------------------------------------------------------------
// Register Name   : REG_COMMON_APB_AON_DMA_SYS_SEL
// Register Offset : 0x3108
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_COMMON_APB_AON_DMA_SYS_SEL                                       BIT(0)
...
/*---------------------------------------------------------------------------
// Register Name   : REG_COMMON_APB_DSIPLL_LOCK_STATUS
// Register Offset : 0x31D8
// Description     : 
---------------------------------------------------------------------------*/

#define BIT_COMMON_APB_INT_REQ_DSIPLL_UNLOCK_STATUS                          BIT(14)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_UNLOCK_STATUS_RAW_STS                  BIT(13)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_UNLOCK_STATUS_RAW                      BIT(12)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_UNLOCK_STATUS_CLR                      BIT(9)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_UNLOCK_STATUS_EN                       BIT(8)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_LOCK_STATUS                            BIT(6)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_LOCK_STATUS_RAW_STS                    BIT(5)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_LOCK_STATUS_RAW                        BIT(4)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_LOCK_STATUS_CLR                        BIT(1)
#define BIT_COMMON_APB_INT_REQ_DSIPLL_LOCK_STATUS_EN                         BIT(0)
