 ...
 ******************************************************************************/
#ifndef _SC7731E_DISPC_GLB_REG_U_H_
#define _SC7731E_DISPC_GLB_REG_U_H_
...
#define BIT2_DISPC_PLL_SEL_CFG		BIT(2)
#define BIT_DISPC_PLL_SEL_MSK		BIT2_DISPC_PLL_SEL_CFG | BIT1_DISPC_PLL_SEL_CFG | BIT0_DISPC_PLL_SEL_CFG
...
#define BIT2_DISPC_DPI_SEL_CFG		BIT(2)
#define BIT_DISPC_DPI_SEL_MSK		BIT0_DISPC_DPI_SEL_CFG | BIT1_DISPC_DPI_SEL_CFG | BIT2_DISPC_DPI_SEL_CFG
...
#define DSI_ISO_CONFIG_REG	REGS_AON_APB_BASE + 0x01A4
#define BIT_DSI_SW_EN		BIT(2)

#define DPHY_PW_CONFIG_REG	REGS_AON_APB_BASE + 0x0024
#define BIT_MIPI_DSI_PS_PD_S	BIT(15)
#define BIT_MIPI_DSI_PS_PD_L	BIT(14)

#define DPHY_CKG_EN G_DISPC_AHB_BASE + 0x0040
#define BIT_DPHY_REF_CKG_EN	BIT(1)
#define BIT_DPHY_CFG_CKG_EN	BIT(0)

enum{
	DISPC_PLL_SEL_128M = 0,
