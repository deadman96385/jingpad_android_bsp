...
static int32_t lcd_hx8389c_tshark2_j3_init(struct panel_spec *self)
{
	int32_t i;
	...
	LCD_PRINT("lcd_hx8389c_tshark2_j3_init \n");
...
static uint32_t hx8389c_tshark2_j3_readid(struct panel_spec *self)
{
#if 0
	uint32 j =0;
	...
	LCD_PRINT("lcd_hx8389c_mipi2 read id!\n");
	...
	for(j = 0; j < 4; j++){
		...
		if((0x53 == read_data[0])&&(0x44 == read_data[1])&&(0x90 == read_data[2]))
#else
		if((0x55 == read_data[0])&&(0xB8 == read_data[1])&&(0x90 == read_data[2]))
#endif
		{
			LCD_PRINT("lcd_hx8389c_mipi read id success!\n");
			return 0x8389;
		}
	}
...
static struct panel_operations lcd_hx8389c_mipi_operations = {
	.panel_init = lcd_hx8389c_tshark2_j3_init,
	.panel_readid = hx8389c_tshark2_j3_readid,
};
