/* drivers/video/sprdfb/lcd_nt35596h_mipi.c
 *
 * Support for nt35596h mipi LCD device
 *
...
static int32_t nt35596h_mipi_init(struct panel_spec *self)
{
	...
	LCD_PRINT("sprdfb:nt35596h_mipi_init\n");
...
static uint32_t nt35596h_readid(struct panel_spec *self)
{
	...
	LCD_PRINT("sprdfb:lcd_nt35596h_mipi read id!\n");
