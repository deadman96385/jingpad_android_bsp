...
static int32_t lcd_hx8369b_tshark2_j3_init(struct panel_spec *self)
{
	int32_t i;
...
static uint32_t hx8369b_tshark2_j3_readid(struct panel_spec *self)
{
#if 0
	uint32 j =0;
...
static struct panel_operations lcd_hx8369b_mipi_operations = {
	.panel_init = lcd_hx8369b_tshark2_j3_init,
	.panel_readid = hx8369b_tshark2_j3_readid,
};
...
struct panel_spec lcd_hx8369b_tshark2_j3_mipi_spec = {
	.width = 540,
	.height = 960,
	.fps = 60,
	.type = LCD_MODE_DSI,
