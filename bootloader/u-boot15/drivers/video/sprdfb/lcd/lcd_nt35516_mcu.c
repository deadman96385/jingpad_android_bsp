/* drivers/video/sc8810/lcd_nt35516_mcu.c
 *
 *
 *
 *
...
//	send_cmd(0xF303); send_data(0x0015);
	...
	send_cmd(0xB100); send_data(0x00FC);
	
	send_cmd(0xB700); send_data(0x0000);
	send_cmd(0xB701); send_data(0x0000);

	send_cmd(0xC800); send_data(0x0001);
	send_cmd(0xC801); send_data(0x0000);
	send_cmd(0xC802); send_data(0x0046);
	send_cmd(0xC803); send_data(0x001E);
	send_cmd(0xC804); send_data(0x0046);
	send_cmd(0xC805); send_data(0x001E);
	send_cmd(0xC806); send_data(0x0046);
	send_cmd(0xC807); send_data(0x001E);
	send_cmd(0xC808); send_data(0x0046);
	send_cmd(0xC809); send_data(0x001E);
	send_cmd(0xC80A); send_data(0x0064);
	send_cmd(0xC80B); send_data(0x003C);//64
	send_cmd(0xC80C); send_data(0x003C);//64
	send_cmd(0xC80D); send_data(0x0064);
	send_cmd(0xC80E); send_data(0x0064);
	send_cmd(0xC80F); send_data(0x003C);//64
	send_cmd(0xC810); send_data(0x003C);//64
	send_cmd(0xC811); send_data(0x0064);
	...
	send_cmd(0xB100); send_data(0x0005); 
	...
	send_cmd(0xB700); send_data(0x0034);//44
	send_cmd(0xB701); send_data(0x0034);//44
	send_cmd(0xB702); send_data(0x0034);//44

//	send_cmd(0xB800); send_data(0x0020);//ADD 2012_9_24
//	send_cmd(0xB801); send_data(0x0020);
//	send_cmd(0xB802); send_data(0x0020);

	send_cmd(0xB300); send_data(0x0012);//10
	send_cmd(0xB301); send_data(0x0012);//10
	send_cmd(0xB302); send_data(0x0012);//10

	send_cmd(0xB900); send_data(0x0034);///*0x24 --> 0x14*/
	send_cmd(0xB901); send_data(0x0034);
	send_cmd(0xB902); send_data(0x0034);

	send_cmd(0xB400); send_data(0x000A);//0A
	send_cmd(0xB401); send_data(0x000A);//0A
	send_cmd(0xB402); send_data(0x000A);//0A
	
	/*Sett VGLX boosting time  AVEVDD */
	send_cmd(0xBA00); send_data(0x0024);///*0x24 --> 0x14*/
	send_cmd(0xBA01); send_data(0x0024);
	send_cmd(0xBA02); send_data(0x0024);

	send_cmd(0xCB00); send_data(0x0084);//ADD 2012_9_24
	send_cmd(0xCB01); send_data(0x0063);
	...
	send_cmd(0xBE00); send_data(0x004E); /* Setting VCOM Offset Voltage  0x4E\u017e??ª0x57  20111019 LIYAN*/
	...
	send_cmd(0x4C00); send_data(0x0011);
...
{
	LCD_PRINT("nt35516_invalidate_rect \n");

	return self->ops->panel_set_window(self, left, top,
			right, bottom);
}

static int32_t nt35516_read_id(struct panel_spec *self)
{
	int32_t id  = 0;
	send_data_t send_cmd = self->info.mcu->ops->send_cmd;
