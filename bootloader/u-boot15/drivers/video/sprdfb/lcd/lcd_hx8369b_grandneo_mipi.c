...
static int32_t lcd_hx8369b_grandneo_init(struct panel_spec *self)
{
	int32_t i;
	...
	LCD_PRINT("lcd_hx8369b_grandneo_init\n");
...
static uint32_t hx8369b_grandneo_readid(struct panel_spec *self)
{
#if 0
	uint32 j =0;
...
static struct panel_operations lcd_hx8369b_mipi_operations = {
	.panel_init = lcd_hx8369b_grandneo_init,
	.panel_readid = hx8369b_grandneo_readid,
};
...
struct panel_spec lcd_hx8369b_grandneo_mipi_spec = {
	.width = 480,
	.height = 800,
	.fps = 60,
	.type = LCD_MODE_DSI,
