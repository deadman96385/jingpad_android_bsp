...
static  uint8_t init_data[] = {
    ...
    0x15, 0x00, 0x00, 0x02,0x3A,0x9C,
    0x15, 0x00, 0x00, 0x02,0x5A,0x9C,
    //2020/03/04 modify
    ...
    0x15, 0x00, 0x00, 0x02,0x56,0xA3,
    0x15, 0x00, 0x00, 0x02,0x46,0x70,
    0x15, 0x00, 0x00, 0x02,0x47,0x38,
    0x15, 0x00, 0x00, 0x02,0x1F,0x9C,
    0x15, 0x00, 0x00, 0x02,0x26,0x9C,
    0x15, 0x00, 0x00, 0x02,0x33,0x9C,
    0x15, 0x00, 0x00, 0x02,0x42,0x9C,
    0x15, 0x00, 0x00, 0x02,0x4B,0x9C,
    0x15, 0x00, 0x00, 0x02,0x4F,0x9C,
    0x15, 0x00, 0x00, 0x02,0x5D,0x9C,
    0x15, 0x00, 0x00, 0x02,0x61,0x9C,

    0x15, 0x00, 0x00, 0x02,0xFF,0x26,

    0x15, 0x00, 0x00, 0x02,0xFB,0x01,
    0x15, 0x00, 0x00, 0x02,0x31,0x91,
    0x15, 0x00, 0x00, 0x02,0x63,0x9C,
    0x15, 0x00, 0x00, 0x02,0x67,0x9C,
    0x15, 0x00, 0x00, 0x02,0x73,0x9C,
    0x15, 0x00, 0x00, 0x02,0x7A,0x9C,
    0x15, 0x00, 0x00, 0x02,0x82,0x9C,
    0x15, 0x00, 0x00, 0x02,0x86,0x9C,
    ////////////////////////////////
    ...
    0x15, 0x00, 0x00, 0x02,0xFB,0x01,
    0x15, 0x00, 0x00, 0x02,0x01,0x22,
    0x15, 0x00, 0x00, 0x02,0x06,0x1C,
    0x15, 0x00, 0x00, 0x02,0x07,0x1C,
    0x15, 0x00, 0x00, 0x02,0x17,0x22,
    0x15, 0x00, 0x00, 0x02,0x1C,0x1C,
    0x15, 0x00, 0x00, 0x02,0x1D,0x1C,
    0x15, 0x00, 0x00, 0x02,0x86,0x14,
    ///////////////////////////////////////

    0x15, 0x00, 0x00, 0x02,0xFF,0x10,

    0x15, 0x00, 0x00, 0x02,0xFB,0x01,
    0x15, 0x00, 0x00, 0x02,0xBA,0x03,  //02 3lane 03 4lane
...
static int nt36525b_readid(void)
{
    ...
    printk("nt36525b readid :0x%x,0x%x, adc: %d\n",read_buf[0],read_buf[2],lcd_adc);
    if(read_buf[0] == 0x25) {
        pr_info("nt36525b read id success!\n");
        pr_info("nt36525b read id:0x%x,0x%x,0x%x,0x%x\n",read_buf[0],read_buf[1],read_buf[2],read_buf[3]);
        return 0;
        }
...
static struct panel_info nt36525b_info = {
    /* common parameters */
    .lcd_name = "lcd_nt36525b_boe_mipi_hdp",
    .type = SPRD_PANEL_TYPE_MIPI,
    .bpp = 24,
    //.fps = 60,
    .width = 720,
    .height = 1600,
    .pixel_clk = 96000000, //76800000,  //76800000, /*Hz*/
    .rgb_timing = {
        .hfp = 100,
        .hbp = 120,
        .hsync = 2,
