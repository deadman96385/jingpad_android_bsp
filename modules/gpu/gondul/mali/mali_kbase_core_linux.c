...
static ssize_t show_dump_mali_registers(struct device *dev,
		struct device_attribute *attr,
		char * const buf)
{
	struct kbase_device *kbdev;
...
static DEVICE_ATTR(dump_mali_registers, S_IRUGO,
		show_dump_mali_registers, NULL);
...
static struct attribute *kbase_attrs[] = {
	...
	&dev_attr_dump_mali_registers.attr,
