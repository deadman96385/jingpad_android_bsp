...
//#define CONFIG_TOUCHSCREEN_GOODIX_GT738X_UPDATE
//#define CONFIG_TOUCHSCREEN_GOODIX_GT738X_GESTURE
#define CONFIG_TOUCHSCREEN_GOODIX_GT738X_TOOLS
...
extern int goodix_do_fw_update(int mode);
