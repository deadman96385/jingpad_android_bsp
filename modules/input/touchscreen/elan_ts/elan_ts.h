...
struct elan_finger_struct {
	...
	int recv_2nd_packet;	/*recv second finger packet flag*/
};
...
extern int elan_ts_set_power_state(struct i2c_client *client, int state);
extern void elan_release_point(void);
