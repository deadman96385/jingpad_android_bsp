...
#define SPRD_MPU_DUMP_ADDR(v) \
		((((v) & GENMASK(31, 8)) >> 1) | ((v) & GENMASK(6, 0)))
					...
					u32 pub)
{
	...
	dump_addr = mpu_info[pub].dump_paddr - core->ddr_addr_offset;
	writel_relaxed(SPRD_MPU_DUMP_ADDR(dump_addr),
