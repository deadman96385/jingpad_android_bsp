...
#define AWINIC_CODE_VERSION "V0.0.4-V1.0.4"	/* "code version"-"excel version" */
...
int aw_parsing_bin_file(struct aw_bin *bin)
{
	...
	pr_info("aw86801 bin->all_bin_parse_num is %d\n",
		bin->all_bin_parse_num);
	pr_info("aw86801 bin->multi_bin_parse_num is %d\n",
		bin->multi_bin_parse_num);
	pr_info("aw86801 bin->single_bin_parse_num is %d\n",
		bin->single_bin_parse_num);
