...
static struct snd_soc_dai_driver vbc_dais[BE_DAI_ID_MAX] = {
	...
	/* 34: BE_DAI_ID_NORMAL_AP01_P_SMTPA */
	{
	...
	/* 35: BE_DAI_ID_NORMAL_AP23_SMTPA */
	{
	...
	/* 43: BE_DAI_ID_RECOGNISE_CAPTURE */
	{
