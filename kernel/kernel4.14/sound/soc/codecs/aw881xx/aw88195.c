...
int aw88195_st_check(void *aw881xx)
{
	int ret = -1;
	uint16_t reg_val = 0;
	struct aw881xx *aw88195 = (struct aw881xx *)aw881xx;
	...
	if ((reg_val & (~AW88195_BIT_SYSST_CHECK_MASK)) ==
		...
		pr_info("%s: check fail, reg_val=0x%04x\n",
			__func__, reg_val);
	}
...
int aw88195_update_hw_params(void *aw881xx)
{
	...
	aw88195_i2c_write_bits(aw88195, AW88195_REG_I2SCTRL,
		AW88195_BIT_I2SCTRL_SR_MASK, AW88195_BIT_I2SCTRL_SR_48K);

	if (aw88195->rate == 32000 || aw88195->rate == 16000 ||
	    aw88195->rate == 8000)
		aw88195_i2c_write(aw88195, AW88195_REG_PLLCTRL1, 0x3f07);
	else
		aw88195_i2c_write(aw88195, AW88195_REG_PLLCTRL1, 0x7f07);
