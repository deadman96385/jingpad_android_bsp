...
enum opt_code
{
  ...
  OPT_march_ = 1041,                         /* -march= */
  OPT_mbig_endian = 1042,                    /* -mbig-endian */
  OPT_mbionic = 1043,                        /* -mbionic */
  OPT_mcmodel_ = 1044,                       /* -mcmodel= */
  OPT_mcpu_ = 1045,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1046,         /* -mfix-cortex-a53-835769 */
  OPT_mgeneral_regs_only = 1047,             /* -mgeneral-regs-only */
  OPT_mglibc = 1048,                         /* -mglibc */
  OPT_mlittle_endian = 1049,                 /* -mlittle-endian */
  OPT_momit_leaf_frame_pointer = 1050,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1051,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1052,                  /* -mtls-dialect= */
  OPT_mtune_ = 1053,                         /* -mtune= */
  OPT_muclibc = 1054,                        /* -muclibc */
  OPT_n = 1055,                              /* -n */
  OPT_no_canonical_prefixes = 1056,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1057,              /* -no-integrated-cpp */
  OPT_nocpp = 1058,                          /* -nocpp */
  OPT_nodefaultlibs = 1059,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1060,                   /* -nostartfiles */
  OPT_nostdinc = 1061,                       /* -nostdinc */
  OPT_nostdinc__ = 1062,                     /* -nostdinc++ */
  OPT_nostdlib = 1063,                       /* -nostdlib */
  OPT_o = 1064,                              /* -o */
  OPT_p = 1065,                              /* -p */
  OPT_pass_exit_codes = 1066,                /* -pass-exit-codes */
  /* OPT_pedantic = 1067, */                 /* -pedantic */
  OPT_pedantic_errors = 1068,                /* -pedantic-errors */
  OPT_pg = 1069,                             /* -pg */
  OPT_pie = 1070,                            /* -pie */
  OPT_pipe = 1071,                           /* -pipe */
  OPT_posix = 1072,                          /* -posix */
  OPT_print_file_name_ = 1073,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1074,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1075,          /* -print-multi-directory */
  OPT_print_multi_lib = 1076,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1077,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1078,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1079,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1080,               /* -print-prog-name= */
  OPT_print_search_dirs = 1081,              /* -print-search-dirs */
  OPT_print_sysroot = 1082,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1083,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1084,                        /* -profile */
  OPT_pthread = 1085,                        /* -pthread */
  OPT_quiet = 1086,                          /* -quiet */
  OPT_r = 1087,                              /* -r */
  OPT_rdynamic = 1088,                       /* -rdynamic */
  OPT_remap = 1089,                          /* -remap */
  OPT_s = 1090,                              /* -s */
  OPT_s_bc_abi = 1091,                       /* -s-bc-abi */
  OPT_save_temps = 1092,                     /* -save-temps */
  OPT_save_temps_ = 1093,                    /* -save-temps= */
  OPT_shared = 1094,                         /* -shared */
  OPT_shared_libgcc = 1095,                  /* -shared-libgcc */
  /* OPT_specs = 1096, */                    /* -specs */
  OPT_specs_ = 1097,                         /* -specs= */
  OPT_static = 1098,                         /* -static */
  OPT_static_libasan = 1099,                 /* -static-libasan */
  OPT_static_libgcc = 1100,                  /* -static-libgcc */
  OPT_static_libgcj = 1101,                  /* -static-libgcj */
  OPT_static_libgfortran = 1102,             /* -static-libgfortran */
  OPT_static_libgo = 1103,                   /* -static-libgo */
  OPT_static_libstdc__ = 1104,               /* -static-libstdc++ */
  OPT_static_libtsan = 1105,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1106, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1107, */                /* -std=c++0x */
  OPT_std_c__11 = 1108,                      /* -std=c++11 */
  OPT_std_c__1y = 1109,                      /* -std=c++1y */
  OPT_std_c__98 = 1110,                      /* -std=c++98 */
  OPT_std_c11 = 1111,                        /* -std=c11 */
  /* OPT_std_c1x = 1112, */                  /* -std=c1x */
  /* OPT_std_c89 = 1113, */                  /* -std=c89 */
  OPT_std_c90 = 1114,                        /* -std=c90 */
  OPT_std_c99 = 1115,                        /* -std=c99 */
  /* OPT_std_c9x = 1116, */                  /* -std=c9x */
  OPT_std_f2003 = 1117,                      /* -std=f2003 */
  OPT_std_f2008 = 1118,                      /* -std=f2008 */
  OPT_std_f2008ts = 1119,                    /* -std=f2008ts */
  OPT_std_f95 = 1120,                        /* -std=f95 */
  OPT_std_gnu = 1121,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1122, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1123, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1124,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1125,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1126,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1127,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1128, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1129, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1130,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1131,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1132, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1133, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1134,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1135, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1136, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1137, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1138,                     /* -std=legacy */
  OPT_symbolic = 1139,                       /* -symbolic */
  OPT_t = 1140,                              /* -t */
  OPT_time = 1141,                           /* -time */
  OPT_time_ = 1142,                          /* -time= */
  OPT_tno_android_cc = 1143,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1144,                 /* -tno-android-ld */
  OPT_traditional = 1145,                    /* -traditional */
  OPT_traditional_cpp = 1146,                /* -traditional-cpp */
  OPT_trigraphs = 1147,                      /* -trigraphs */
  OPT_u = 1148,                              /* -u */
  OPT_undef = 1149,                          /* -undef */
  OPT_v = 1150,                              /* -v */
  OPT_version = 1151,                        /* -version */
  OPT_w = 1152,                              /* -w */
  OPT_wrapper = 1153,                        /* -wrapper */
  OPT_x = 1154,                              /* -x */
  OPT_z = 1155,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
